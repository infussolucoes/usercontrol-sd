object framePacotes: TframePacotes
  ...
  object Label9: TLabel
    ...
    Height = 13
    Caption = 
      'Connectors - (Drives para componentes de conex'#227'o com banco de da' +
      'dos)'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clMaroon
    Font.Height = -11
  ...
  object pckUCDataConnector_dpk: TCheckBox
    ...
    Margins.Right = 0
    Margins.Bottom = 0
    Caption = 'pckUCDataConnector.dpk'
    Enabled = False
    Font.Charset = DEFAULT_CHARSET

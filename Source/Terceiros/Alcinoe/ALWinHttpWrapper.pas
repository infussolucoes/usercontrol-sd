...
{$EXTERNALSYM WINHTTP_PROXY_INFO}
  ...
  LPWINHTTP_CURRENT_USER_IE_PROXY_CONFIG =
...
{$EXTERNALSYM API_SEND_REQUEST}
  WINHTTP_CALLBACK_FLAG_RESOLVE_NAME = (WINHTTP_CALLBACK_STATUS_RESOLVING_NAME +
...
{$EXTERNALSYM WINHTTP_CALLBACK_FLAG_CONNECT_TO_SERVER}
  WINHTTP_CALLBACK_FLAG_SEND_REQUEST = (WINHTTP_CALLBACK_STATUS_SENDING_REQUEST
...
{$EXTERNALSYM WINHTTP_CALLBACK_FLAG_CLOSE_CONNECTION}
  WINHTTP_CALLBACK_FLAG_HANDLES = (WINHTTP_CALLBACK_STATUS_HANDLE_CREATED +
...
function WinHttpSetOption(hInet: HINTERNET; dwOption: DWORD; lpBuffer: Pointer;
...
function WinHttpCreateUrl(var lpUrlComponents: TURLComponents; dwFlags: DWORD;
  pwszUrl: PWideChar; var lpdwUrlLength: DWORD): BOOL; stdcall;
...
function WinHttpGetDefaultProxyConfiguration(var pProxyInfo
  : TWINHTTP_PROXY_INFO): BOOL; stdcall;
{$EXTERNALSYM WinHttpGetDefaultProxyConfiguration}
function WinHttpGetIEProxyConfigForCurrentUser(var pProxyInfo
  : TWINHTTP_CURRENT_USER_IE_PROXY_CONFIG): BOOL; stdcall;
...
function WinHttpOpen(pwszUserAgent: PWideChar; dwAccessType: DWORD;
  pwszProxyName, pwszProxyBypass: PWideChar; dwFlags: DWORD)
  : HINTERNET; stdcall;
{$EXTERNALSYM WinHttpOpen}
function WinHttpSetTimeouts(HINTERNET: HINTERNET; dwResolveTimeout: Integer;
  dwConnectTimeout: Integer; dwSendTimeout: Integer; dwReceiveTimeout: Integer)
  : BOOL; stdcall;
...
function WinHttpSetCredentials(hRequest: HINTERNET; AuthTargets: DWORD;
...
function WinHttpReceiveResponse(hRequest: HINTERNET; lpReserved: Pointer)
  : BOOL; stdcall;
...
function WinHttpReadData(hRequest: HINTERNET; lpBuffer: Pointer;
  dwNumberOfBytesToRead: DWORD; var lpdwNumberOfBytesRead: DWORD)
  : BOOL; stdcall;
...
function WinHttpSetStatusCallback(HINTERNET: HINTERNET;
  lpfnInternetCallback: PFNWinHttpStatusCallback; dwNotificationFlags: DWORD;
  dwReserved: DWORD): PFNWinHttpStatusCallback; stdcall;
...
function WinHttpAddRequestHeaders;
  external winhttpdll name 'WinHttpAddRequestHeaders';
...
function WinHttpDetectAutoProxyConfigUrl;
  external winhttpdll name 'WinHttpDetectAutoProxyConfigUrl';
...
function WinHttpQueryAuthSchemes;
  external winhttpdll name 'WinHttpQueryAuthSchemes';
function WinHttpSetCredentials;
  external winhttpdll name 'WinHttpSetCredentials';
...
function WinHttpSetStatusCallback;
  external winhttpdll name 'WinHttpSetStatusCallback';

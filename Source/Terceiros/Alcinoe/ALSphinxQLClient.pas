...
Type
  ...
  Public
    ...
    Constructor Create(aHost: AnsiString; aPort: integer; alib: TALMySqlLibrary;
      const aOpenConnectionOptions: TALMySQLOptions = nil); overload; virtual;
  end;
...
{ *************************************************** }
procedure TalSphinxQlClient.Connect(Host: AnsiString; Port: integer;
  Const Options: TALMySQLOptions = nil);
begin

  inherited Connect(Host, Port, '', // DataBaseName
    '', // Login
    '', // Password
    '', // CharSet
    0, // ClientFlag
...
constructor TalSphinxQlConnectionPoolClient.Create(aHost: AnsiString;
  aPort: integer; aApiVer: TALMySqlVersion_API;
  const alib: AnsiString = 'libmysql.dll';
  const aOpenConnectionOptions: TALMySQLOptions = nil);
begin

  inherited Create(aHost, aPort, '', // aDataBaseName,
    '', // aLogin,
    '', // aPassword,
    '', // aCharSet: String;
    aApiVer, alib, 0, // aOpenConnectionClientFlag: Cardinal = 0);
...
{ ******************************************************************* }
constructor TalSphinxQlConnectionPoolClient.Create(aHost: AnsiString;
  aPort: integer; alib: TALMySqlLibrary;
  const aOpenConnectionOptions: TALMySQLOptions = nil);
begin
  ...
  inherited Create(aHost, aPort, '', // aDataBaseName,
    ...
    '', // aPassword,
    '', // aCharSet: String;
    alib, 0, // aOpenConnectionClientFlag: Cardinal = 0);
    aOpenConnectionOptions); // aOpenConnectionOptions

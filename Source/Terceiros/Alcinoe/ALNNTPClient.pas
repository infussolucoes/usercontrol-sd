...
type
  ...
  protected
    ...
    Function SendCmd(aCmd: AnsiString; OkResponses: array of Word;
      const MultilineResponse: Boolean = False): AnsiString; virtual;
    Function GetResponse(OkResponses: array of Word;
      const MultilineResponse: Boolean = False): AnsiString;
    Function SocketWrite({$IF CompilerVersion >= 23}const {$ELSE}var
      {$IFEND} Buf; len: Integer): Integer; Virtual;
    Function SocketRead(var Buf; len: Integer): Integer; Virtual;
  public
    constructor Create; virtual;
    destructor Destroy; override;
    Function Connect(const aHost: AnsiString; const APort: Integer)
      : AnsiString; virtual;
    ...
    procedure ListNewsGroups(ALst: TALStrings; wildmat: AnsiString);
      overload; virtual;
    Function ListGroup(NewsGroup: AnsiString): AnsiString; overload; virtual;
    procedure ListGroup(ALst: TALStrings; NewsGroup: AnsiString);
      overload; virtual;
    Function NewsGroups(FromGMTDate: TdateTime; distributions: AnsiString)
      : AnsiString; overload; virtual;
    procedure NewsGroups(FromGMTDate: TdateTime; distributions: AnsiString;
      ALst: TALStrings); overload; virtual;
    Function NewNews(NewsGroups: AnsiString; FromGMTDate: TdateTime;
      distributions: AnsiString): AnsiString; overload; virtual;
    procedure NewNews(NewsGroups: AnsiString; FromGMTDate: TdateTime;
      distributions: AnsiString; ALst: TALStrings); overload; virtual;
    function Group(NewsGroupName: AnsiString): AnsiString; overload; virtual;
    Procedure Group(NewsGroupName: AnsiString; Var EstimatedNumberArticles,
      FirstArticleNumber, LastArticleNumber: Integer); overload; Virtual;
    Function ArticleByNumber(ArticleNumber: Integer): AnsiString;
      overload; virtual;
    Procedure ArticleByNumber(ArticleNumber: Integer;
      Var ArticleContent: AnsiString); overload; virtual;
    Procedure ArticleByNumber(ArticleNumber: Integer;
      Var ArticleBodyContent: AnsiString;
      ArticleHeaderContent: TALNewsArticleHeader); overload; virtual;
    Function ArticleByID(ArticleID: AnsiString): AnsiString; overload; virtual;
    Procedure ArticleByID(ArticleID: AnsiString;
      Var ArticleContent: AnsiString); overload; virtual;
    Procedure ArticleByID(ArticleID: AnsiString;
      Var ArticleBodyContent: AnsiString;
      ArticleHeaderContent: TALNewsArticleHeader); overload; virtual;
    ...
    procedure Article(var ArticleBodyContent: AnsiString;
      ArticleHeaderContent: TALNewsArticleHeader); overload; virtual;
    Function HeadByID(ArticleID: AnsiString): AnsiString; overload; virtual;
    Procedure HeadByID(ArticleID: AnsiString; Var HeadContent: AnsiString);
      overload; virtual;
    Procedure HeadByID(ArticleID: AnsiString;
      HeadContent: TALNewsArticleHeader); overload; virtual;
    Function HeadByNumber(ArticleNumber: Integer): AnsiString;
      overload; virtual;
    Procedure HeadByNumber(ArticleNumber: Integer; Var HeadContent: AnsiString);
      overload; virtual;
    Procedure HeadByNumber(ArticleNumber: Integer;
      HeadContent: TALNewsArticleHeader); overload; virtual;
    ...
    Procedure BodyByID(ArticleID: AnsiString; Var BodyContent: AnsiString);
      overload; virtual;
    Function BodyByNumber(ArticleNumber: Integer): AnsiString;
      overload; virtual;
    Procedure BodyByNumber(ArticleNumber: Integer; Var BodyContent: AnsiString);
      overload; virtual;
    ...
    Procedure StatByID(ArticleID: AnsiString; Var ArticleNumber: Integer);
      overload; virtual;
    Function StatByNumber(ArticleNumber: Integer): AnsiString;
      overload; virtual;
    Procedure StatByNumber(ArticleNumber: Integer; Var ArticleID: AnsiString);
      overload; virtual;
    Function Stat: AnsiString; overload; virtual;
    Procedure Stat(Var ArticleID: AnsiString; Var ArticleNumber: Integer);
      overload; virtual;
    Function XHDRByID(HeaderName: AnsiString; ArticleID: AnsiString)
      : AnsiString; overload; virtual;
    Procedure XHDRByID(HeaderName: AnsiString; ArticleID: AnsiString;
      var HeaderContent: AnsiString); overload; virtual;
    Function XHDRByNumber(HeaderName: AnsiString; ArticleNumber: Integer)
      : AnsiString; overload; virtual;
    Procedure XHDRByNumber(HeaderName: AnsiString; ArticleNumber: Integer;
      var HeaderContent: AnsiString); overload; virtual;
    Function XHDR(HeaderName: AnsiString): AnsiString; overload; virtual;
    Procedure XHDR(HeaderName: AnsiString; var HeaderContent: AnsiString);
      overload; virtual;
    Function Next: Boolean; overload; virtual;
    Procedure Next(Var ArticleNumber: Integer; Var ArticleID: AnsiString);
      overload; virtual;
    Function Last: Boolean; overload; virtual;
    Procedure Last(Var ArticleNumber: Integer; Var ArticleID: AnsiString);
      overload; virtual;
    Function IHave(ArticleID: AnsiString; ArticleContent: AnsiString)
      : Boolean; virtual;
    ...
    Procedure Post(HeaderContent: TALNewsArticleHeader;
      BodyContent: AnsiString); overload; virtual;
    Procedure PostMultipartMixed(HeaderContent: TALNewsArticleHeader;
      InlineText, InlineTextContentType: AnsiString;
      Attachments: TALMultiPartMixedContents); virtual;
...
{ ******************************************************************************* }
Procedure ALNNTPClientSplitResponseLine(aResponse: AnsiString;
  ALst: TALStrings);
Begin
  aResponse := ALTrim(aResponse); // 211 111225 12861 362539 nzn.fr.delphi
  aResponse := AlStringReplace(aResponse, #9, ' ', [RfReplaceAll]);
  // 211 111225 12861 362539 nzn.fr.delphi
  While alPos('  ', aResponse) > 0 do
    aResponse := AlStringReplace(aResponse, '  ', ' ', [RfReplaceAll]);
  // 211 111225 12861 362539 nzn.fr.delphi
  aResponse := ALTrim(AlStringReplace(aResponse, ' ', #13#10, [RfReplaceAll]));
  // 211
  // 111225
  // 12861
  // 362539
...
{ ************************************************************************************************ }
Function ALNNTPClientExtractTextFromMultilineResponse(aMultilineResponse
...
begin
  ...
  If (ln > 4) and (Result[ln] = #10) and (Result[ln - 1] = #13) and
    (Result[ln - 2] = '.') and (Result[ln - 3] = #10) and (Result[ln - 4] = #13)
  then
    delete(Result, ln - 4, 5);
...
{ ******************************************************************************************************** }
Function ALNNTPClientEnclosedInAngleBrackets(Str: AnsiString;
  const insSpace: Boolean = True): AnsiString;
begin
  Result := ALTrim(Str);
  If Result <> '' then
  begin
...
{ **************************************************************************************** }
Function TAlNNTPClient.Connect(const aHost: AnsiString; const APort: Integer)
  : AnsiString;
...
begin
  ALst.Text := ALTrim(ALNNTPClientExtractTextFromMultilineResponse
    (ListDistributions));
end;
...
Function TAlNNTPClient.NewsGroups(FromGMTDate: TdateTime;
  distributions: AnsiString): AnsiString;
begin
  Result := SendCmd('NEWGROUPS ' + ALFormatDateTime('yymmdd" "hhnnss',
    FromGMTDate, ALDefaultFormatSettings) + ' GMT' +
    ALNNTPClientEnclosedInAngleBrackets(distributions), [231], True);
end;

{ ****************************************************************************************************** }
procedure TAlNNTPClient.NewsGroups(FromGMTDate: TdateTime;
  distributions: AnsiString; ALst: TALStrings);
begin
  ALst.Text := ALTrim(ALNNTPClientExtractTextFromMultilineResponse
    (NewsGroups(FromGMTDate, distributions)));
end;
...
Function TAlNNTPClient.NewNews(NewsGroups: AnsiString; FromGMTDate: TdateTime;
  distributions: AnsiString): AnsiString;
begin
  Result := SendCmd('NEWNEWS ' + NewsGroups + ' ' +
    ALFormatDateTime('yymmdd" "hhnnss', FromGMTDate, ALDefaultFormatSettings) +
    ' GMT' + ALNNTPClientEnclosedInAngleBrackets(distributions), [230], True);
end;

{ *************************************************************************************************************************** }
procedure TAlNNTPClient.NewNews(NewsGroups: AnsiString; FromGMTDate: TdateTime;
  distributions: AnsiString; ALst: TALStrings);
begin
  ALst.Text := ALTrim(ALNNTPClientExtractTextFromMultilineResponse
    (NewNews(NewsGroups, FromGMTDate, distributions)));
end;
...
begin
  Result := SendCmd('GROUP ' + ALTrim(NewsGroupName), [211], False);
  // 211 111225 12861 362539 nzn.fr.delphi
end;

{ ****************************************************** }
Procedure TAlNNTPClient.Group(NewsGroupName: AnsiString;
  Var EstimatedNumberArticles, FirstArticleNumber, LastArticleNumber: Integer);
Var
  ALst: TALStringList;
Begin
  ...
  Try
    ...
    If ALst.Count < 4 then
      raise Exception.Create('GROUP cmd Error');
    If not ALTryStrToInt(ALst[1], EstimatedNumberArticles) then
      raise Exception.Create('GROUP cmd Error');
    If not ALTryStrToInt(ALst[2], FirstArticleNumber) then
      raise Exception.Create('GROUP cmd Error');
    If not ALTryStrToInt(ALst[3], LastArticleNumber) then
      raise Exception.Create('GROUP cmd Error');
  finally
    ALst.Free;
  end;
...
begin
  Result := SendCmd('ARTICLE' + ALNNTPClientEnclosedInAngleBrackets(ArticleID),
    [220], True);
end;

{ ***************************************************************************************** }
procedure TAlNNTPClient.ArticleByID(ArticleID: AnsiString;
  var ArticleContent: AnsiString);
begin
  ArticleContent := ALNNTPClientExtractTextFromMultilineResponse
...
Var
  P: Integer;
begin
  ArticleBodyContent := ALNNTPClientExtractTextFromMultilineResponse
    (ArticleByID(ArticleID));
  P := alPos(#13#10#13#10, ArticleBodyContent);
  If P <= 0 then
    raise Exception.Create('Bad formated article!');
...
{ ************************************************************************************************************** }
procedure TAlNNTPClient.Article(var ArticleBodyContent: AnsiString;
  ArticleHeaderContent: TALNewsArticleHeader);
Var
  P: Integer;
begin
...
begin
  Result := SendCmd('HEAD' + ALNNTPClientEnclosedInAngleBrackets(ArticleID),
    [221], True);
end;

{ *********************************************************************************** }
procedure TAlNNTPClient.HeadByID(ArticleID: AnsiString;
  var HeadContent: AnsiString);
begin
  HeadContent := ALNNTPClientExtractTextFromMultilineResponse
    (HeadByID(ArticleID));
end;

{ ***************************************************************************************** }
procedure TAlNNTPClient.HeadByID(ArticleID: AnsiString;
  HeadContent: TALNewsArticleHeader);
begin
  HeadContent.RawHeaderText := ALNNTPClientExtractTextFromMultilineResponse
    (HeadByID(ArticleID));
end;
...
{ **************************************************************************************** }
procedure TAlNNTPClient.HeadByNumber(ArticleNumber: Integer;
  var HeadContent: AnsiString);
begin
  HeadContent := ALNNTPClientExtractTextFromMultilineResponse
    (HeadByNumber(ArticleNumber));
end;
...
begin
  HeadContent.RawHeaderText :=
    ALNNTPClientExtractTextFromMultilineResponse(Head);
end;

{ ***************************************************************** }
function TAlNNTPClient.BodyByID(ArticleID: AnsiString): AnsiString;
begin
  Result := SendCmd('BODY' + ALNNTPClientEnclosedInAngleBrackets(ArticleID),
    [222], True);
end;

{ *********************************************************************************** }
procedure TAlNNTPClient.BodyByID(ArticleID: AnsiString;
  var BodyContent: AnsiString);
begin
  BodyContent := ALNNTPClientExtractTextFromMultilineResponse
    (BodyByID(ArticleID));
end;
...
{ **************************************************************************************** }
procedure TAlNNTPClient.BodyByNumber(ArticleNumber: Integer;
  var BodyContent: AnsiString);
begin
  BodyContent := ALNNTPClientExtractTextFromMultilineResponse
    (BodyByNumber(ArticleNumber));
end;
...
begin
  Result := SendCmd('STAT' + ALNNTPClientEnclosedInAngleBrackets(ArticleID),
    [223], False); // 223 10110 <23445@sdcsvax.ARPA> status
end;

{ ********************************************************************************** }
procedure TAlNNTPClient.StatByID(ArticleID: AnsiString;
  var ArticleNumber: Integer);
Var
  ALst: TALStringList;
Begin
  ALst := TALStringList.Create;
  Try
    ...
    If ALst.Count < 3 then
      raise Exception.Create('STAT cmd Error');
    If not ALTryStrToInt(ALst[1], ArticleNumber) then
      raise Exception.Create('STAT cmd Error');
  finally
    ALst.Free;
  end;
...
begin
  Result := SendCmd('STAT ' + ALIntToStr(ArticleNumber), [223], False);
  // 223 10110 <23445@sdcsvax.ARPA> status
end;

{ ************************************************************************************** }
procedure TAlNNTPClient.StatByNumber(ArticleNumber: Integer;
  var ArticleID: AnsiString);
Var
  ALst: TALStringList;
Begin
  ALst := TALStringList.Create;
...
begin
  Result := SendCmd('STAT', [223], False);
  // 223 10110 <23445@sdcsvax.ARPA> status
end;

{ ********************************************************************************** }
procedure TAlNNTPClient.Stat(var ArticleID: AnsiString;
  var ArticleNumber: Integer);
Var
  ALst: TALStringList;
Begin
...
{ XHDR header [range|<message-id>]
  ...
  430 no such article
  502 no permission }
function TAlNNTPClient.XHDRByID(HeaderName: AnsiString; ArticleID: AnsiString)
  : AnsiString;
begin
  Result := SendCmd('XHDR ' + HeaderName + ' ' +
    ALNNTPClientEnclosedInAngleBrackets(ArticleID), [221], True);
end;

{ ************************************************************************************************************* }
procedure TAlNNTPClient.XHDRByID(HeaderName: AnsiString; ArticleID: AnsiString;
  Var HeaderContent: AnsiString);
begin
  HeaderContent := ALNNTPClientExtractTextFromMultilineResponse
    (XHDRByID(HeaderName, ArticleID));
end;

{ ********************************************************************************************** }
function TAlNNTPClient.XHDRByNumber(HeaderName: AnsiString;
  ArticleNumber: Integer): AnsiString;
begin
  Result := SendCmd('XHDR ' + HeaderName + ' ' + ALIntToStr(ArticleNumber),
    [221], True);
end;

{ ****************************************************************************************************************** }
procedure TAlNNTPClient.XHDRByNumber(HeaderName: AnsiString;
  ArticleNumber: Integer; Var HeaderContent: AnsiString);
begin
  HeaderContent := ALNNTPClientExtractTextFromMultilineResponse
    (XHDRByNumber(HeaderName, ArticleNumber));
end;
...
{ ********************************************************************************** }
procedure TAlNNTPClient.XHDR(HeaderName: AnsiString;
  Var HeaderContent: AnsiString);
begin
  HeaderContent := ALNNTPClientExtractTextFromMultilineResponse
    (XHDR(HeaderName));
...
Var
  aStatutCode: Integer;
begin
  aStatutCode := GetStatusCodeFromResponse(SendCmd('NEXT', [223, 421, 422],
    False)); // 223 10113 <21495@nudebch.uucp> article retrieved - request text separately
  Result := aStatutCode = 223;
end;

{ ********************************************************************************** }
procedure TAlNNTPClient.Next(var ArticleNumber: Integer;
  var ArticleID: AnsiString);
Var
  ALst: TALStringList;
begin
  ...
  Try
    ...
    If ALst.Count < 3 then
      raise Exception.Create('NEXT cmd Error');
    If not ALTryStrToInt(ALst[1], ArticleNumber) then
      raise Exception.Create('NEXT cmd Error');
...
Var
  aStatutCode: Integer;
begin
  aStatutCode := GetStatusCodeFromResponse(SendCmd('LAST', [223, 421, 422],
    False)); // 223 10113 <21495@nudebch.uucp> article retrieved
  Result := aStatutCode = 223;
end;

{ ********************************************************************************** }
procedure TAlNNTPClient.Last(var ArticleNumber: Integer;
  var ArticleID: AnsiString);
Var
  ALst: TALStringList;
begin
  ...
  Try
    ...
    If ALst.Count < 3 then
      raise Exception.Create('LAST cmd Error');
    if not ALTryStrToInt(ALst[1], ArticleNumber) then
      raise Exception.Create('LAST cmd Error');
    ArticleID := ALst[2]; // <21495@nudebch.uucp>
  finally
...
begin
  Result := True;
  aResponse := SendCmd('IHAVE' + ALNNTPClientEnclosedInAngleBrackets(ArticleID),
    [335, 435], False);
  aStatusCode := GetStatusCodeFromResponse(aResponse);
  If aStatusCode = 435 then
  begin
    Result := False;
    exit;
  end;
  ...
  i := 2;
  while i <= length(ArticleContent) Do
  begin
    If (ArticleContent[i] = '.') and (ArticleContent[i - 1] = #10) and
      (ArticleContent[i - 2] = #13) then
      Insert('.', ArticleContent, i);
    inc(i);
  end;
...
{ ***************************************************************************************** }
procedure TAlNNTPClient.Post(HeaderContent: TALNewsArticleHeader;
...
Var
  aMultipartMixedEncoder: TALMultipartMixedEncoder;
  Str: AnsiString;
begin
  aMultipartMixedEncoder := TALMultipartMixedEncoder.Create;
  try
    aMultipartMixedEncoder.Encode(InlineText, InlineTextContentType,
      Attachments);
    with aMultipartMixedEncoder do
    begin
      HeaderContent.ContentType := 'multipart/mixed; boundary="' +
        DataStream.Boundary + '"';
...
{ ******************************************************************************* }
function TAlNNTPClient.GetStatusCodeFromResponse(aResponse: AnsiString)
  : Integer;
...
{ Commands consist of a command word, which in some cases may be
  ...
  command lines. }
function TAlNNTPClient.SendCmd(aCmd: AnsiString; OkResponses: array of Word;
  Const MultilineResponse: Boolean = False): AnsiString;
Var
  P: PAnsiChar;
  L: Integer;
...
function TAlNNTPClient.GetResponse(OkResponses: array of Word;
  Const MultilineResponse: Boolean = False): AnsiString;
Var
  aBuffStr: AnsiString;
...
begin
  ...
  begin
    ...
    If (aGoodResponse = 0) or (not MultilineResponse) then
    begin
      If (aResponseLength > 1) and (Result[aResponseLength] = #10) and
        (Result[aResponseLength - 1] = #13) then
        Break;
    end
    else
    begin
      If (aResponseLength > 4) and (Result[aResponseLength] = #10) and
        (Result[aResponseLength - 1] = #13) and
        (Result[aResponseLength - 2] = '.') and
        (Result[aResponseLength - 3] = #10) and
        (Result[aResponseLength - 4] = #13) then
        Break;
    end;
  end;

  If aGoodResponse <> 1 then
    Raise Exception.Create(String(Result));
end;

{ **************************************************************************************************************** }
Function TAlNNTPClient.SocketWrite({$IF CompilerVersion >= 23}const {$ELSE}var

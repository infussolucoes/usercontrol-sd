...
type
  ...
  { Enum Field Types }
  TMysqlFieldTypes = (FIELD_TYPE_DECIMAL = 0, FIELD_TYPE_TINY = 1,
    FIELD_TYPE_SHORT = 2, FIELD_TYPE_LONG = 3, FIELD_TYPE_FLOAT = 4,
    FIELD_TYPE_DOUBLE = 5, FIELD_TYPE_NULL = 6, FIELD_TYPE_TIMESTAMP = 7,
    FIELD_TYPE_LONGLONG = 8, FIELD_TYPE_INT24 = 9, FIELD_TYPE_DATE = 10,
    FIELD_TYPE_TIME = 11, FIELD_TYPE_DATETIME = 12, FIELD_TYPE_YEAR = 13,
    FIELD_TYPE_NEWDATE = 14, FIELD_TYPE_VARCHAR = 15,
    // <--ADDED by fduenas 20-06-2006
    FIELD_TYPE_BIT = 16, // <--ADDED by fduenas 20-06-2006
    FIELD_TYPE_NEWDECIMAL = 246, // <--ADDED by fduenas 20-06-2006
    FIELD_TYPE_ENUM = 247, FIELD_TYPE_SET = 248, FIELD_TYPE_TINY_BLOB = 249,
  ...
  TMySqlSetOption = (MYSQL_OPTION_MULTI_STATEMENTS_ON,
    MYSQL_OPTION_MULTI_STATEMENTS_OFF);

  TMysqlStmtAttrType = (STMT_ATTR_UPDATE_MAX_LENGTH, STMT_ATTR_CURSOR_TYPE,
    STMT_ATTR_PREFETCH_ROWS);

  TMysqlShutdownLevel = (SHUTDOWN_DEFAULT = 0,
    SHUTDOWN_WAIT_CONNECTIONS = MYSQL_SHUTDOWN_KILLABLE_CONNECT,
    SHUTDOWN_WAIT_TRANSACTIONS = MYSQL_SHUTDOWN_KILLABLE_TRANS,
    SHUTDOWN_WAIT_UPDATES = MYSQL_SHUTDOWN_KILLABLE_UPDATE,
    SHUTDOWN_WAIT_ALL_BUFFERS = (MYSQL_SHUTDOWN_KILLABLE_UPDATE shl 1),
    SHUTDOWN_WAIT_CRITICAL_BUFFERS, KILL_QUERY = 254, KILL_CONNECTION = 255);

  TMYSQL_CLIENT_OPTIONS = (CLIENT_LONG_PASSWORD,
    { = 1;	   new more secure passwords }
    ...
    { 2^18 = 262144; Enable Multi-results in PS-protocol }
  ...
  TMysqlStmtState = (MYSQL_STMT_INIT_DONE = 1, MYSQL_STMT_PREPARE_DONE,
  ...
  PREP_STMT_STATE = (MY_ST_UNKNOWN, MY_ST_PREPARE, MY_ST_EXECUTE);
  ...
  public
    ...
    { deprecated for mysql_error/mysql_errno }
    mysql_errno: function(Handle: PMYSQL): UInt; stdcall;
    mysql_error: function(Handle: PMYSQL): PAnsiChar; stdcall;
    mysql_escape_string: function(PTo, PFrom: PAnsiChar; Len: ULong): ULong;
      stdcall; { deprecated for mysql_real_escape_string }
    mysql_fetch_field: function(Result: PMYSQL_RES): PMYSQL_FIELD; stdcall;
    mysql_fetch_field_direct: function(Result: PMYSQL_RES; FieldNo: UInt)
      : PMYSQL_FIELD; stdcall;
    ...
    mysql_list_dbs: function(Handle: PMYSQL; Wild: PAnsiChar)
      : PMYSQL_RES; stdcall;
    mysql_list_fields: function(Handle: PMYSQL; const table, Wild: PAnsiChar)
      : PMYSQL_RES; stdcall;
    mysql_list_processes: function(Handle: PMYSQL): PMYSQL_RES; stdcall;
    mysql_list_tables: function(Handle: PMYSQL; const Wild: PAnsiChar)
      : PMYSQL_RES; stdcall;
    mysql_num_fields: function(Result: PMYSQL_RES): UInt; stdcall;
    mysql_num_rows: function(Result: PMYSQL_RES): uLongLong; stdcall;
    mysql_options: function(Handle: PMYSQL; Option: TMySqlOption;
      const Arg: PAnsiChar): Integer; stdcall;
    mysql_ping: function(Handle: PMYSQL): Integer; stdcall;
    mysql_query: function(Handle: PMYSQL; const Query: PAnsiChar): Integer;
      stdcall; { deprecated for mysql_real_query }
    mysql_real_connect: function(Handle: PMYSQL;
      const host, user, Passwd, db: PAnsiChar; port: UInt;
      const UnixSocket: PAnsiChar; ClientFlag: ULong): PMYSQL; stdcall;
    mysql_real_escape_string: function(Handle: PMYSQL; PTo: PAnsiChar;
      const PFrom: PAnsiChar; length: ULong): ULong; stdcall;
    mysql_real_query: function(Handle: PMYSQL; const Query: PAnsiChar;
      length: ULong): Integer; stdcall;
    mysql_refresh: function(Handle: PMYSQL; Options: UInt): Integer; stdcall;
    mysql_row_seek: function(Result: PMYSQL_RES; offset: PMYSQL_ROWS)
      : PMYSQL_ROWS; stdcall;
    mysql_row_tell: function(Result: PMYSQL_RES): PMYSQL_ROWS; stdcall;
    mysql_select_db: function(Handle: PMYSQL; const db: PAnsiChar)
      : Integer; stdcall;
    mysql_ssl_set: function(Handle: PMYSQL; const key, cert, CA, CApath,
      cipher: PAnsiChar): Byte; stdcall;
    ...
    mysql_library_init: function(Argc: Integer; Argv, Groups: Pointer)
      : Integer; stdcall;
    mysql_library_end: procedure; stdcall;
    mysql_server_init: function(Argc: Integer; Argv, Groups: Pointer)
      : Integer; stdcall;
    mysql_server_end: procedure; stdcall;
    mysql_change_user: function(MYSQL: PMYSQL; const user: PAnsiChar;
      const Passwd: PAnsiChar; const db: PAnsiChar): Byte;
    mysql_field_count: function(Handle: PMYSQL): UInt; stdcall;
    mysql_get_client_version: function: ULong; stdcall;
    mysql_send_query: function(MYSQL: PMYSQL; const Query: PAnsiChar;
      length: ULong): Integer; stdcall;
    ...
    mysql_hex_string: function(PTo, PFrom: PAnsiChar; Len: ULong)
      : ULong; stdcall;
    ...
    mysql_set_character_set: function(Handle: PMYSQL; csname: PAnsiChar)
      : Integer; stdcall;
    mysql_set_server_option: function(Handle: PMYSQL; Option: TMySqlSetOption)
      : Integer; stdcall;
    mysql_shutdown: function(Handle: PMYSQL;
      shutdown_level: TMysqlShutdownLevel): Integer; stdcall;
    { new argument 4.1 }
    ...
    mysql_stmt_attr_get: function(stmt: PMYSQL_STMT; Option: TMysqlStmtAttrType;
      Arg: PAnsiChar): Byte; stdcall;
    mysql_stmt_attr_set: function(stmt: PMYSQL_STMT; Option: TMysqlStmtAttrType;
      const Arg: PAnsiChar): Byte; stdcall; { augmented 5.0.2/6 }
    mysql_stmt_bind_param: function(stmt: PMYSQL_STMT;
      bind: Pointer { BIND record } ): Byte; stdcall;
    mysql_stmt_bind_result: function(stmt: PMYSQL_STMT;
      bind: Pointer { BIND record } ): Byte; stdcall;
    mysql_stmt_close: function(stmt: PMYSQL_STMT): Byte; stdcall;
    mysql_stmt_data_seek: procedure(stmt: PMYSQL_STMT;
      offset: uLongLong); stdcall;
    ...
    mysql_stmt_fetch_column: function(stmt: PMYSQL_STMT;
      bind: Pointer { BIND record }; column: UInt; offset: ULong)
      : Integer; stdcall;
    ...
    mysql_stmt_prepare: function(stmt: PMYSQL_STMT; const Query: PAnsiChar;
      length: ULong): Integer; stdcall;
    mysql_stmt_reset: function(stmt: PMYSQL_STMT): Byte; stdcall;
    mysql_stmt_result_metadata: function(stmt: PMYSQL_STMT)
      : PMYSQL_RES; stdcall;
    mysql_stmt_row_seek: function(stmt: PMYSQL_STMT; offset: PMYSQL_ROWS)
      : PMYSQL_ROWS; stdcall;
    mysql_stmt_row_tell: function(stmt: PMYSQL_STMT): PMYSQL_ROWS; stdcall;
    mysql_stmt_send_long_data: function(stmt: PMYSQL_STMT;
      parameter_number: UInt; const data: PAnsiChar; length: ULong)
      : Byte; stdcall;
    ...
    mysql_get_character_set_info: procedure(Handle: PMYSQL;
      cs: PMY_CHARSET_INFO); stdcall;
...
Begin
  ...
  begin
    ...
    begin
      ...
      mysql_character_set_name := GetProcAddress(Flibmysql,
      ...
      mysql_dump_debug_info := GetProcAddress(Flibmysql,
      ...
      mysql_fetch_field_direct := GetProcAddress(Flibmysql,
      ...
      mysql_get_client_info := GetProcAddress(Flibmysql,
      ...
      mysql_get_server_info := GetProcAddress(Flibmysql,
      ...
      mysql_real_escape_string := GetProcAddress(Flibmysql,
      ...
      mysql_set_character_set := GetProcAddress(Flibmysql,
        'mysql_set_character_set');
      mysql_set_server_option := GetProcAddress(Flibmysql,
      ...
      mysql_stmt_affected_rows := GetProcAddress(Flibmysql,
      ...
      mysql_stmt_bind_param := GetProcAddress(Flibmysql,
        'mysql_stmt_bind_param');
      mysql_stmt_bind_result := GetProcAddress(Flibmysql,
      ...
      mysql_stmt_fetch_column := GetProcAddress(Flibmysql,
        'mysql_stmt_fetch_column');
      mysql_stmt_field_count := GetProcAddress(Flibmysql,
        'mysql_stmt_field_count');
      mysql_stmt_free_result := GetProcAddress(Flibmysql,
      ...
      mysql_stmt_next_result := GetProcAddress(Flibmysql,
        'mysql_stmt_next_result');
      mysql_stmt_num_rows := GetProcAddress(Flibmysql, 'mysql_stmt_num_rows');
      mysql_stmt_param_count := GetProcAddress(Flibmysql,
        'mysql_stmt_param_count');
      mysql_stmt_param_metadata := GetProcAddress(Flibmysql,
      ...
      mysql_stmt_result_metadata := GetProcAddress(Flibmysql,
      ...
      mysql_stmt_send_long_data := GetProcAddress(Flibmysql,
        'mysql_stmt_send_long_data');
      mysql_stmt_sqlstate := GetProcAddress(Flibmysql, 'mysql_stmt_sqlstate');
      mysql_stmt_store_result := GetProcAddress(Flibmysql,
        'mysql_stmt_store_result');
      mysql_get_character_set_info := GetProcAddress(Flibmysql,
        'mysql_get_character_set_info');

      Result := assigned(mysql_affected_rows) and
        assigned(mysql_character_set_name) and assigned(mysql_close) and
        assigned(mysql_data_seek) and assigned(mysql_debug) and
        assigned(mysql_dump_debug_info) and assigned(mysql_eof) and
        assigned(mysql_errno) and assigned(mysql_error) and
        assigned(mysql_escape_string) and assigned(mysql_fetch_field) and
        assigned(mysql_fetch_field_direct) and assigned(mysql_fetch_fields) and
        assigned(mysql_fetch_lengths) and assigned(mysql_fetch_row) and
        assigned(mysql_field_seek) and assigned(mysql_field_tell) and
        assigned(mysql_free_result) and assigned(mysql_get_client_info) and
        assigned(mysql_get_host_info) and assigned(mysql_get_proto_info) and
        assigned(mysql_get_server_info) and assigned(mysql_info) and
        assigned(mysql_init) and assigned(mysql_insert_id) and
        assigned(mysql_kill) and assigned(mysql_list_dbs) and
        assigned(mysql_list_fields) and assigned(mysql_list_processes) and
        assigned(mysql_list_tables) and assigned(mysql_num_fields) and
        assigned(mysql_num_rows) and assigned(mysql_options) and
        assigned(mysql_ping) and assigned(mysql_query) and
        assigned(mysql_real_connect) and assigned(mysql_real_escape_string) and
        assigned(mysql_real_query) and assigned(mysql_refresh) and
        assigned(mysql_row_seek) and assigned(mysql_row_tell) and
        assigned(mysql_select_db) and assigned(mysql_ssl_set) and
        assigned(mysql_stat) and assigned(mysql_store_result) and
        assigned(mysql_thread_id) and assigned(mysql_use_result) and
        ((FVersion_API in [MYSQL55]) or assigned(my_init)) and
        assigned(mysql_thread_init) and assigned(mysql_thread_end) and
        assigned(mysql_thread_safe) and assigned(mysql_library_init) and
        assigned(mysql_library_end) and assigned(mysql_server_init) and
        assigned(mysql_server_end) and assigned(mysql_change_user) and
        assigned(mysql_field_count) and assigned(mysql_get_client_version) and
        assigned(mysql_send_query) and assigned(mysql_read_query_result) and
        assigned(mysql_autocommit) and assigned(mysql_commit) and
        assigned(mysql_get_server_version) and assigned(mysql_hex_string) and
        assigned(mysql_more_results) and assigned(mysql_next_result) and
        assigned(mysql_rollback) and assigned(mysql_set_character_set) and
        assigned(mysql_set_server_option) and assigned(mysql_shutdown) and
        assigned(mysql_sqlstate) and assigned(mysql_warning_count) and
        assigned(mysql_stmt_affected_rows) and assigned(mysql_stmt_attr_get) and
        assigned(mysql_stmt_attr_set) and assigned(mysql_stmt_bind_param) and
        assigned(mysql_stmt_bind_result) and assigned(mysql_stmt_close) and
        assigned(mysql_stmt_data_seek) and assigned(mysql_stmt_errno) and
        assigned(mysql_stmt_error) and assigned(mysql_stmt_execute) and
        assigned(mysql_stmt_fetch) and assigned(mysql_stmt_fetch_column) and
        assigned(mysql_stmt_field_count) and assigned(mysql_stmt_free_result)
        and assigned(mysql_stmt_init) and assigned(mysql_stmt_insert_id) and
        ((FVersion_API = MYSQL50) or assigned(mysql_stmt_next_result)) and
        assigned(mysql_stmt_num_rows) and assigned(mysql_stmt_param_count) and
        assigned(mysql_stmt_param_metadata) and assigned(mysql_stmt_prepare) and
        assigned(mysql_stmt_reset) and assigned(mysql_stmt_result_metadata) and
        assigned(mysql_stmt_row_seek) and assigned(mysql_stmt_row_tell) and
        assigned(mysql_stmt_send_long_data) and assigned(mysql_stmt_sqlstate)
        and assigned(mysql_stmt_store_result) and
      ...
      begin
        ...
        if mysql_library_init(0, nil, nil) <> 0 then
        begin
          Unload;

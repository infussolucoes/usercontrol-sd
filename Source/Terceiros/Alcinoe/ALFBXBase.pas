...
{$ENDIF}
  ...
  { FB25_UP }
  FB_SHUTDOWN_CALLBACK = function(const reason, mask: Integer; arg: Pointer)
    : Integer; cdecl;
  { FB25_UP }
...
type
  ...
  TBlobGetSegmentFn = function(hnd: Pointer; buffer: PAnsiChar;
    buf_size: ISCUShort; var result_len: ISCUShort): Smallint; cdecl;

  TBlobPutSegmentFn = procedure(hnd: PPointer; buffer: PAnsiChar;
    buf_size: ISCUShort); cdecl;

  TBlobLSeekFn = function(hnd: PPointer; mode: ISCUShort; offset: ISCLong)
    : ISCLong; cdecl;
...
type
  ...
  ISC_PRINT_CALLBACK = procedure(p: Pointer; v: ISC_SHORT;
    const c: PAnsiChar); cdecl;
  ISC_VERSION_CALLBACK = procedure(p: Pointer; const c: PAnsiChar); cdecl;
  ISC_EVENT_CALLBACK = procedure(user_data: Pointer; length: ISC_USHORT;
    const updated: PAnsiChar); cdecl;
...
type
  info_db_class = (isc_info_db_class_INVALID_0, isc_info_db_class_access,
    isc_info_db_class_y_valve, isc_info_db_class_rem_int,
    isc_info_db_class_rem_srvr, isc_info_db_class_INVALID_5,
    isc_info_db_class_INVALID_6, isc_info_db_class_pipe_int,
    isc_info_db_class_pipe_srvr, isc_info_db_class_sam_int,
    isc_info_db_class_sam_srvr, isc_info_db_class_gateway,
    isc_info_db_class_cache, isc_info_db_class_classic_access,
    isc_info_db_class_server_access,
    isc_info_db_class_last_value (* Leave this LAST! *)
    );

  info_db_provider = (isc_info_db_code_INVALID_0, isc_info_db_code_rdb_eln,
    isc_info_db_code_rdb_vms, isc_info_db_code_interbase,
...
type
  ...
  protected
    ...
    BLOB_display: function(blob_id: PISCQuad; database: IscDbHandle;
      transaction: IscTrHandle; field_name: PAnsiChar): Integer; stdcall;
    BLOB_dump: function(blob_id: PISCQuad; database: IscDbHandle;
      transaction: IscTrHandle; file_name: PAnsiChar): Integer; stdcall;
    BLOB_edit: function(blob_id: PISCQuad; database: IscDbHandle;
      transaction: IscTrHandle; field_name: PAnsiChar): Integer; stdcall;
    BLOB_get: function(Stream: PBStream): Integer; stdcall;
    BLOB_load: function(blob_id: PISCQuad; database: IscDbHandle;
      transaction: IscTrHandle; file_name: PAnsiChar): Integer; stdcall;
    BLOB_open: function(blob: IscBlobHandle; buffer: PAnsiChar; length: Integer)
      : PBStream; stdcall;
    BLOB_put: function(x: AnsiChar; Stream: PBStream): Integer; stdcall;
    BLOB_text_dump: function(blob_id: PISCQuad; database: IscDbHandle;
      transaction: IscTrHandle; file_name: PAnsiChar): Integer; stdcall;
    BLOB_text_load: function(blob_id: PISCQuad; database: IscDbHandle;
      transaction: IscTrHandle; file_name: PAnsiChar): Integer; stdcall;
    Bopen: function(blob_id: PISCQuad; database: IscDbHandle;
      transaction: IscTrHandle; mode: PAnsiChar): PBStream; stdcall;
    isc_add_user: function(STATUS: PISCStatus; user_data: PUserSecData)
      : Integer; stdcall;
    isc_array_gen_sdl: function(STATUS: PISCStatus; desc: PISCArrayDesc;
      sdl_buffer_length: PSmallint; sdl_buffer: PAnsiChar;
      sdl_length: PSmallint): ISCStatus; stdcall;
    isc_array_get_slice: function(STATUS: PISCStatus; db_handle: PIscDbHandle;
      trans_handle: PIscTrHandle; array_id: PISCQuad; desc: PISCArrayDesc;
      array_: PPointer; slice_length: PISCLong): ISCStatus; stdcall;
    isc_array_lookup_bounds: function(STATUS: PISCStatus;
      db_handle: PIscDbHandle; trans_handle: PIscTrHandle;
      relation_name, field_name: PAnsiChar; desc: PISCArrayDesc)
      : ISCStatus; stdcall;
    isc_array_lookup_desc: function(STATUS: PISCStatus; db_handle: PIscDbHandle;
      ...
      desc: PISCArrayDesc): ISCStatus; stdcall;
    isc_array_put_slice: function(STATUS: PISCStatus; db_handle: PIscDbHandle;
      trans_handle: PIscTrHandle; array_id: PISCQuad; desc: PISCArrayDesc;
      array_: PPointer; slice_length: PISCLong): ISCStatus; stdcall;
    isc_array_set_desc: function(STATUS: PISCStatus;
      relation_name, field_name: PAnsiChar;
      sql_dtype, sql_length, dimensions: PSmallint; desc: PISCArrayDesc)
      : ISCStatus; stdcall;
    isc_attach_database: function(user_status: PISCStatus;
      file_length: Smallint; file_name: PAnsiChar; Handle: PIscDbHandle;
      dpb_length: Smallint; dpb: PAnsiChar): ISCStatus; stdcall;
    isc_blob_default_desc: procedure(desc: PISCBlobDesc;
      relation_name, field_name: PAnsiChar); stdcall;
    isc_blob_gen_bpb: function(STATUS: PISCStatus;
      to_desc, from_desc: PISCBlobDesc; bpb_buffer_length: Word;
      bpb_buffer: PAnsiChar; bpb_length: PWord): ISCStatus; stdcall;
    isc_blob_info: function(user_status: PISCStatus;
      blob_handle: PIscBlobHandle; item_length: Smallint; items: PAnsiChar;
      buffer_length: Smallint; buffer: PAnsiChar): ISCStatus; stdcall;
    isc_blob_lookup_desc: function(STATUS: PISCStatus; db_handle: PIscDbHandle;
      trans_handle: PIscTrHandle; relation_name, field_name: PAnsiChar;
      desc: PISCBlobDesc; global: PAnsiChar): ISCStatus; stdcall;
    isc_blob_set_desc: function(STATUS: PISCStatus;
      relation_name, field_name: PAnsiChar;
      subtype, charset, segment_size: Smallint; desc: PISCBlobDesc)
      : ISCStatus; stdcall;
    isc_cancel_blob: function(user_status: PISCStatus;
      blob_handle: PIscBlobHandle): ISCStatus; stdcall;
    isc_cancel_events: function(user_status: PISCStatus; Handle: PIscDbHandle;
      id: PISCLong): ISCStatus; stdcall;
    isc_close: function(user_status: PISCStatus; name: PAnsiChar)
      : ISCStatus; stdcall;
    isc_close_blob: function(user_status: PISCStatus;
      blob_handle: PIscBlobHandle): ISCStatus; stdcall;
    isc_commit_retaining: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle): ISCStatus; stdcall;
    isc_commit_transaction: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle): ISCStatus; stdcall;
    isc_compile_request: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; req_handle: PIscReqHandle; blr_length: Smallint;
      blr: PAnsiChar): ISCStatus; stdcall;
    isc_compile_request2: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; req_handle: PIscReqHandle; blr_length: Smallint;
      blr: PAnsiChar): ISCStatus; stdcall;
    ...
    isc_create_blob2: function(user_status: PISCStatus; db_handle: PIscDbHandle;
      tra_handle: PIscTrHandle; blob_handle: PIscBlobHandle; blob_id: PISCQuad;
      bpb_length: Smallint; bpb: PAnsiChar): ISCStatus; stdcall;
    isc_create_database: function(user_status: PISCStatus;
      file_length: Smallint; file_name: PAnsiChar; Handle: PIscDbHandle;
      dpb_length: Smallint; dpb: PAnsiChar; db_type: Smallint)
      : ISCStatus; stdcall;
    isc_database_info: function(user_status: PISCStatus; Handle: PIscDbHandle;
      ...
      buffer: PAnsiChar): ISCStatus; stdcall;
    isc_ddl: function(user_status: PISCStatus; db_handle: PIscDbHandle;
      tra_handle: PIscTrHandle; length: Smallint; ddl: PAnsiChar)
      : ISCStatus; stdcall;
    isc_declare: function(user_status: PISCStatus; statement, cursor: PAnsiChar)
      : ISCStatus; stdcall;
    isc_decode_date: procedure(date: PISCQuad; times: PPointer); stdcall;
    isc_decode_sql_date: procedure(date: PISCDate;
      times_arg: PPointer); stdcall;
    isc_decode_sql_time: procedure(sql_time: PISCTime;
      times_arg: PPointer); stdcall;
    isc_decode_timestamp: procedure(date: PISCTimeStamp;
      times_arg: PPointer); stdcall;
    isc_delete_user: function(STATUS: PISCStatus; user_data: PUserSecData)
      : Integer; stdcall;
    isc_describe: function(user_status: PISCStatus; name: PAnsiChar;
      sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_describe_bind: function(user_status: PISCStatus; name: PAnsiChar;
      sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_detach_database: function(user_status: PISCStatus; Handle: PIscDbHandle)
      : ISCStatus; stdcall;
    isc_drop_database: function(user_status: PISCStatus; Handle: PIscDbHandle)
      : ISCStatus; stdcall;
    isc_dsql_alloc_statement2: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; stmt_handle: PIscStmtHandle): ISCStatus; stdcall;
    isc_dsql_allocate_statement: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; stmt_handle: PIscStmtHandle): ISCStatus; stdcall;
    isc_dsql_describe: function(user_status: PISCStatus;
      stmt_handle: PIscStmtHandle; dialect: Word; sqlda: PXSQLDA)
      : ISCStatus; stdcall;
    isc_dsql_describe_bind: function(user_status: PISCStatus;
      stmt_handle: PIscStmtHandle; dialect: Word; sqlda: PXSQLDA)
      : ISCStatus; stdcall;
    isc_dsql_exec_immed2: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; tra_handle: PIscTrHandle; length: Word;
      string_: PAnsiChar; dialect: Word; in_sqlda, out_sqlda: PXSQLDA)
      : ISCStatus; stdcall;
    isc_dsql_exec_immed3_m: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; tra_handle: PIscTrHandle; length: Word;
      string_: PAnsiChar; dialect, in_blr_length: Word; in_blr: PAnsiChar;
      in_msg_type, in_msg_length: Word; in_msg: PAnsiChar; out_blr_length: Word;
      out_blr: PAnsiChar; out_msg_type, out_msg_length: Word;
      out_msg: PAnsiChar): ISCStatus; stdcall;
    isc_dsql_execute: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; stmt_handle: PIscStmtHandle; dialect: Word;
      sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_dsql_execute_immediate: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; tra_handle: PIscTrHandle; length: Word;
      string_: PAnsiChar; dialect: Word; sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_dsql_execute_immediate_m: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; tra_handle: PIscTrHandle; length: Word;
      string_: PAnsiChar; dialect, blr_length: Word; blr: PAnsiChar;
      msg_type, msg_length: Word; msg: PAnsiChar): ISCStatus; stdcall;
    isc_dsql_execute_m: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; stmt_handle: PIscStmtHandle; blr_length: Word;
      blr: PAnsiChar; msg_type, msg_length: Word; msg: PAnsiChar)
      : ISCStatus; stdcall;
    isc_dsql_execute2: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; stmt_handle: PIscStmtHandle; dialect: Word;
      in_sqlda, out_sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_dsql_execute2_m: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; stmt_handle: PIscStmtHandle;
      in_blr_length: Word; in_blr: PAnsiChar; in_msg_type, in_msg_length: Word;
      in_msg: PAnsiChar; out_blr_length: Word; out_blr: PAnsiChar;
      out_msg_type, out_msg_length: Word; out_msg: PAnsiChar)
      : ISCStatus; stdcall;
    isc_dsql_fetch: function(user_status: PISCStatus;
      stmt_handle: PIscStmtHandle; dialect: Word; sqlda: PXSQLDA)
      : ISCStatus; stdcall;
    isc_dsql_fetch_m: function(user_status: PISCStatus;
      stmt_handle: PIscStmtHandle; blr_length: Word; blr: PAnsiChar;
      msg_type, msg_length: Word; msg: PAnsiChar): ISCStatus; stdcall;
    isc_dsql_finish: function(db_handle: PIscDbHandle): ISCStatus; stdcall;
    isc_dsql_free_statement: function(user_status: PISCStatus;
      stmt_handle: PIscStmtHandle; option: Word): ISCStatus; stdcall;
    isc_dsql_insert: function(user_status: PISCStatus;
      stmt_handle: PIscStmtHandle; dialect: Word; sqlda: PXSQLDA)
      : ISCStatus; stdcall;
    isc_dsql_insert_m: function(user_status: PISCStatus;
      stmt_handle: PIscStmtHandle; blr_length: Word; blr: PAnsiChar;
      msg_type, msg_length: Word; msg: PAnsiChar): ISCStatus; stdcall;
    isc_dsql_prepare: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; stmt_handle: PIscStmtHandle; length: Word;
      string_: PAnsiChar; dialect: Word; sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_dsql_prepare_m: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; stmt_handle: PIscStmtHandle; length: Word;
      string_: PAnsiChar; dialect, item_length: Word; items: PAnsiChar;
      buffer_length: Word; buffer: PAnsiChar): ISCStatus; stdcall;
    isc_dsql_release: function(user_status: PISCStatus; name: PAnsiChar)
      : ISCStatus; stdcall;
    isc_dsql_set_cursor_name: function(user_status: PISCStatus;
      stmt_handle: PIscStmtHandle; cursor: PAnsiChar; type_: Word)
      : ISCStatus; stdcall;
    isc_dsql_sql_info: function(user_status: PISCStatus;
      stmt_handle: PIscStmtHandle; item_length: Smallint; items: PAnsiChar;
      buffer_length: Smallint; buffer: PAnsiChar): ISCStatus; stdcall;
    isc_embed_dsql_close: function(user_status: PISCStatus; name: PAnsiChar)
      : ISCStatus; stdcall;
    isc_embed_dsql_declare: function(user_status: PISCStatus;
      stmt_name, cursor: PAnsiChar): ISCStatus; stdcall;
    isc_embed_dsql_describe: function(user_status: PISCStatus;
      stmt_name: PAnsiChar; dialect: Word; sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_embed_dsql_describe_bind: function(user_status: PISCStatus;
      stmt_name: PAnsiChar; dialect: Word; sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_embed_dsql_execute: function(user_status: PISCStatus;
      trans_handle: PIscTrHandle; stmt_name: PAnsiChar; dialect: Word;
      sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_embed_dsql_execute_immed: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; trans_handle: PIscTrHandle; length: Word;
      string_: PAnsiChar; dialect: Word; sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_embed_dsql_execute2: function(user_status: PISCStatus;
      trans_handle: PIscTrHandle; stmt_name: PAnsiChar; dialect: Word;
      in_sqlda, out_sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_embed_dsql_fetch: function(user_status: PISCStatus;
      cursor_name: PAnsiChar; dialect: Word; sqlda: PXSQLDA)
      : ISCStatus; stdcall;
    isc_embed_dsql_insert: function(user_status: PISCStatus;
      cursor_name: PAnsiChar; dialect: Word; sqlda: PXSQLDA)
      : ISCStatus; stdcall;
    isc_embed_dsql_open: function(user_status: PISCStatus;
      trans_handle: PIscTrHandle; cursor_name: PAnsiChar; dialect: Word;
      sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_embed_dsql_open2: function(user_status: PISCStatus;
      trans_handle: PIscTrHandle; cursor_name: PAnsiChar; dialect: Word;
      in_sqlda, out_sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_embed_dsql_prepare: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; trans_handle: PIscTrHandle; stmt_name: PAnsiChar;
      length: Word; string_: PAnsiChar; dialect: Word; sqlda: PXSQLDA)
      : ISCStatus; stdcall;
    isc_embed_dsql_release: function(user_status: PISCStatus;
      stmt_name: PAnsiChar): ISCStatus; stdcall;
    isc_encode_date: procedure(times: PPointer; date: PISCQuad); stdcall;
    isc_encode_sql_date: procedure(times_arg: PPointer;
      date: PISCDate); stdcall;
    isc_encode_sql_time: procedure(times_arg: PPointer;
      ISC_TIME: PISCTime); stdcall;
    isc_encode_timestamp: procedure(times_arg: PPointer;
      date: PISCTimeStamp); stdcall;
    isc_event_block: function(event_buffer, result_buffer: PPAnsiChar;
      count: Word; v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14,
      v15: PAnsiChar): ISCLong; cdecl;
    { FB21_UP }
    isc_event_block_a: function(event_buffer, result_buffer: PPAnsiChar;
      count: Word; name_buffer: PPAnsiChar): Word; stdcall;
    { FB21_UP }
    isc_event_counts: procedure(ser_status: PISCStatus; buffer_length: Smallint;
      event_buffer, result_buffer: PAnsiChar); stdcall;
    isc_execute: function(user_status: PISCStatus; trans_handle: PIscTrHandle;
      name: PAnsiChar; sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_execute_immediate: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; trans_handle: PIscTrHandle; length: PSmallint;
      string_: PAnsiChar): ISCStatus; stdcall;
    isc_expand_dpb: procedure(dpb: PPAnsiChar; dpb_size: PSmallint;
      name_buffer: PPAnsiChar); cdecl;
    isc_fetch: function(user_status: PISCStatus; name: PAnsiChar;
      sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_free: function(blk: PAnsiChar): ISCLong; stdcall;
    isc_ftof: function(string_: PAnsiChar; length1: Word; field: PAnsiChar;
      length2: Word): ISCStatus; stdcall;
    isc_get_segment: function(user_status: PISCStatus;
      blob_handle: PIscBlobHandle; length: PWord; buffer_length: Word;
      buffer: PAnsiChar): ISCStatus; stdcall;
    isc_get_slice: function(user_status: PISCStatus; db_handle: PIscDbHandle;
      tra_handle: PIscTrHandle; array_id: PISCQuad; sdl_length: Smallint;
      sdl: PAnsiChar; param_length: Smallint; param: PISCLong;
      slice_length: ISCLong; slice: PPointer; return_length: PISCLong)
      : ISCStatus; stdcall;
    isc_interprete: function(buffer: PAnsiChar; status_vector: PPISCStatus)
      : ISCStatus; stdcall;
    { FB20_UP }
    fb_interpret: function(buffer: PAnsiChar; v: Integer;
      status_vector: PPISCStatus): ISCStatus; stdcall;
    { FB20_UP }
    isc_modify_dpb: function(dpb: PPAnsiChar; dpb_length: PSmallint;
      type_: Word; str: PAnsiChar; str_len: Smallint): Integer; stdcall;
    isc_modify_user: function(STATUS: PISCStatus; user_data: PUserSecData)
      : Integer; stdcall;
    isc_open: function(user_status: PISCStatus; trans_handle: PIscTrHandle;
      name: PAnsiChar; sqlda: PXSQLDA): ISCStatus; stdcall;
    ...
    isc_open_blob2: function(user_status: PISCStatus; db_handle: PIscDbHandle;
      tra_handle: PIscTrHandle; blob_handle: PIscBlobHandle; blob_id: PISCQuad;
      bpb_length: Word; bpb: PAnsiChar): ISCStatus; stdcall;
    isc_portable_integer: function(ptr: PAnsiChar; length: Smallint)
      : ISCInt64; stdcall;
    isc_prepare: function(user_status: PISCStatus; db_handle: PIscDbHandle;
      trans_handle: PIscTrHandle; name: PAnsiChar; length: PSmallint;
      string_: PAnsiChar; sqlda: PXSQLDA): ISCStatus; stdcall;
    isc_prepare_transaction: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle): ISCStatus; stdcall;
    isc_prepare_transaction2: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; msg_length: ISCUShort; msg: PISCUChar)
      : ISCStatus; stdcall;
    isc_print_blr: function(blr: PAnsiChar; callback: ISC_PRINT_CALLBACK;
      callback_argument: PPointer; language: Smallint): ISCStatus; stdcall;
    { FB25_UP }
    fb_print_blr: function(const blr: PAnsiChar; blr_length: ISC_ULONG;
      routine: ISC_PRINT_CALLBACK; user_arg: Pointer; language: Smallint)
      : Integer; stdcall;
    { FB25_UP }
    isc_print_sqlerror: procedure(sqlcode: ISCShort;
      status_vector: PISCStatus); stdcall;
    isc_print_status: function(status_vector: PISCStatus): ISCStatus; stdcall;
    isc_put_segment: function(user_status: PISCStatus;
      blob_handle: PIscBlobHandle; buffer_length: Word; buffer: PAnsiChar)
      : ISCStatus; stdcall;
    isc_put_slice: function(user_status: PISCStatus; db_handle: PIscDbHandle;
      tra_handle: PIscTrHandle; array_id: PISCQuad; sdl_length: Smallint;
      sdl: PAnsiChar; param_length: Smallint; param: PISCLong;
      slice_length: ISCLong; slice: PPointer): ISCStatus; stdcall;
    isc_qtoq: procedure(quad1, quad2: PISCQuad); stdcall;
    isc_que_events: function(user_status: PISCStatus; Handle: PIscDbHandle;
      id: PISCLong; length: ISCUShort; events: PAnsiChar;
      ast: ISC_EVENT_CALLBACK; arg: PPointer): ISCStatus; stdcall;
    isc_receive: function(user_status: PISCStatus; req_handle: PIscReqHandle;
      msg_type, msg_length: Smallint; msg: PPointer; level: Smallint)
      : ISCStatus; stdcall;
    isc_reconnect_transaction: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; tra_handle: PIscTrHandle; length: Smallint;
      id: PAnsiChar): ISCStatus; stdcall;
    isc_release_request: function(user_status: PISCStatus;
      req_handle: PIscReqHandle): ISCStatus; stdcall;
    isc_request_info: function(user_status: PISCStatus;
      req_handle: PIscReqHandle; level, item_length: Smallint; items: PAnsiChar;
      buffer_length: Smallint; buffer: PAnsiChar): ISCStatus; stdcall;
    isc_rollback_retaining: function(status_vector: PISCStatus;
      trans_handle: PIscTrHandle): ISCStatus; stdcall;
    isc_rollback_transaction: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle): ISCStatus; stdcall;
    isc_seek_blob: function(user_status: PISCStatus;
      blob_handle: PIscBlobHandle; mode: Smallint; offset: ISCLong;
      Result_: PISCLong): ISCStatus; stdcall;
    isc_send: function(user_status: PISCStatus; req_handle: PIscReqHandle;
      msg_type, msg_length: Smallint; msg: PPointer; level: Smallint)
      : ISCStatus; stdcall;
    isc_service_attach: function(status_vector: PISCStatus;
      service_length: Word; service_name: PAnsiChar; Handle: PIscSvcHandle;
      spb_length: Word; spb: PAnsiChar): ISCStatus; stdcall;
    isc_service_detach: function(status_vector: PISCStatus;
      Handle: PIscSvcHandle): ISCStatus; stdcall;
    isc_service_query: function(status_vector: PISCStatus;
      svc_handle: PIscSvcHandle; reserved: PIscResvHandle;
      send_spb_length: Word; send_spb: PAnsiChar; request_spb_length: Word;
      request_spb: PAnsiChar; buffer_length: Word; buffer: PAnsiChar)
      : ISCStatus; stdcall;
    isc_service_start: function(status_vector: PISCStatus;
      svc_handle: PIscSvcHandle; reserved: PIscResvHandle; spb_length: Word;
      spb: PAnsiChar): ISCStatus; stdcall;
    { FB25_UP }
    fb_shutdown: function(timeout: Cardinal; const reason: Integer)
      : Integer; stdcall;
    FB_SHUTDOWN_CALLBACK: function(user_status: PISCStatus;
      callback: FB_SHUTDOWN_CALLBACK; const mask: Integer; arg: Pointer)
      : ISC_STATUS; stdcall;
    fb_cancel_operation: function(user_status: PISCStatus; Handle: PIscDbHandle;
      option: ISC_USHORT): ISC_STATUS; stdcall;
    { FB25_UP }
    isc_set_debug: procedure(flag: Integer); stdcall;
    isc_sql_interprete: procedure(sqlcode: Smallint; buffer: PAnsiChar;
      buffer_length: Smallint); stdcall;
    isc_sqlcode: function(user_status: PISCStatus): ISCLong; stdcall;
    { FB25_UP }
    fb_sqlstate: procedure(buffer: PAnsiChar;
      const user_status: PISCStatus); stdcall;
    { FB25_UP }
    isc_start_and_send: function(user_status: PISCStatus;
      req_handle: PIscReqHandle; tra_handle: PIscTrHandle;
      msg_type, msg_length: Smallint; msg: PPointer; level: Smallint)
      : ISCStatus; stdcall;
    isc_start_multiple: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; count: Smallint; vector: PISCTEB)
      : ISCStatus; stdcall;
    isc_start_request: function(user_status: PISCStatus;
      req_handle: PIscReqHandle; tra_handle: PIscTrHandle; level: Smallint)
      : ISCStatus; stdcall;
    isc_start_transaction: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; count: Smallint; db_handle: PIscDbHandle;
      tpb_length: ISCUShort; tpb_ad: PAnsiChar): ISCStatus; cdecl;
    { FB25_UP }
    fb_disconnect_transaction: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle): ISC_STATUS; stdcall;
    { FB25_UP }
    isc_transact_request: function(user_status: PISCStatus;
      db_handle: PIscDbHandle; tra_handle: PIscTrHandle; blr_length: Word;
      blr: PAnsiChar; in_msg_length: Word; in_msg: PAnsiChar;
      out_msg_length: Word; out_msg: PAnsiChar): ISCStatus; stdcall;
    isc_transaction_info: function(user_status: PISCStatus;
      tra_handle: PIscTrHandle; item_length: Smallint; items: PAnsiChar;
      buffer_length: Smallint; buffer: PAnsiChar): ISCStatus; stdcall;
    isc_unwind_request: function(user_status: PISCStatus;
      req_handle: PIscTrHandle; level: Smallint): ISCStatus; stdcall;
    isc_vax_integer: function(ptr: PAnsiChar; length: Smallint)
      : ISCLong; stdcall;
    isc_version: function(db_handle: PIscDbHandle;
      callback: ISC_VERSION_CALLBACK; callback_argument: PPointer)
      : Integer; stdcall;
    isc_vtof: procedure(string1, string2: PAnsiChar; length: Word); stdcall;
    isc_vtov: procedure(string1, string2: PAnsiChar; length: Smallint); stdcall;
    isc_wait_for_event: function(user_status: PISCStatus; Handle: PIscDbHandle;
      length: Smallint; events, buffer: PAnsiChar): ISCStatus; stdcall;
    { FB15_UP }
    isc_reset_fpe: function(fpe_status: Word): ISCLong; stdcall;
    { FB15_UP }
    { FB15 }
    isc_get_client_version: procedure(version: PAnsiChar); stdcall;
...
begin
  ...
  begin
    ...
    begin
      ...
      isc_array_lookup_bounds := GetProcAddress(FGDS32Lib,
        'isc_array_lookup_bounds');
      isc_array_lookup_desc := GetProcAddress(FGDS32Lib,
      ...
      isc_blob_default_desc := GetProcAddress(FGDS32Lib,
      ...
      isc_commit_transaction := GetProcAddress(FGDS32Lib,
      ...
      isc_dsql_alloc_statement2 := GetProcAddress(FGDS32Lib,
        'isc_dsql_alloc_statement2');
      isc_dsql_allocate_statement := GetProcAddress(FGDS32Lib,
        'isc_dsql_allocate_statement');
      isc_dsql_describe := GetProcAddress(FGDS32Lib, 'isc_dsql_describe');
      isc_dsql_describe_bind := GetProcAddress(FGDS32Lib,
        'isc_dsql_describe_bind');
      isc_dsql_exec_immed2 := GetProcAddress(FGDS32Lib, 'isc_dsql_exec_immed2');
      isc_dsql_exec_immed3_m := GetProcAddress(FGDS32Lib,
        'isc_dsql_exec_immed3_m');
      isc_dsql_execute := GetProcAddress(FGDS32Lib, 'isc_dsql_execute');
      isc_dsql_execute_immediate := GetProcAddress(FGDS32Lib,
        'isc_dsql_execute_immediate');
      isc_dsql_execute_immediate_m := GetProcAddress(FGDS32Lib,
      ...
      isc_dsql_free_statement := GetProcAddress(FGDS32Lib,
      ...
      isc_dsql_set_cursor_name := GetProcAddress(FGDS32Lib,
      ...
      isc_embed_dsql_declare := GetProcAddress(FGDS32Lib,
        'isc_embed_dsql_declare');
      isc_embed_dsql_describe := GetProcAddress(FGDS32Lib,
        'isc_embed_dsql_describe');
      isc_embed_dsql_describe_bind := GetProcAddress(FGDS32Lib,
        'isc_embed_dsql_describe_bind');
      isc_embed_dsql_execute := GetProcAddress(FGDS32Lib,
        'isc_embed_dsql_execute');
      isc_embed_dsql_execute_immed := GetProcAddress(FGDS32Lib,
        'isc_embed_dsql_execute_immed');
      isc_embed_dsql_execute2 := GetProcAddress(FGDS32Lib,
        'isc_embed_dsql_execute2');
      isc_embed_dsql_fetch := GetProcAddress(FGDS32Lib, 'isc_embed_dsql_fetch');
      isc_embed_dsql_insert := GetProcAddress(FGDS32Lib,
      ...
      isc_embed_dsql_prepare := GetProcAddress(FGDS32Lib,
        'isc_embed_dsql_prepare');
      isc_embed_dsql_release := GetProcAddress(FGDS32Lib,
      ...
      { FB21_UP }
      if Version_Api_Is_FB21_Up then
      begin
      ...
      isc_execute_immediate := GetProcAddress(FGDS32Lib,
      ...
      isc_prepare_transaction := GetProcAddress(FGDS32Lib,
        'isc_prepare_transaction');
      isc_prepare_transaction2 := GetProcAddress(FGDS32Lib,
      ...
      isc_reconnect_transaction := GetProcAddress(FGDS32Lib,
      ...
      isc_rollback_retaining := GetProcAddress(FGDS32Lib,
        'isc_rollback_retaining');
      isc_rollback_transaction := GetProcAddress(FGDS32Lib,
      ...
      isc_start_transaction := GetProcAddress(FGDS32Lib,
      ...
      { FB15_UP }
      if Version_Api_Is_FB15_Up then
      begin
        isc_reset_fpe := GetProcAddress(FGDS32Lib, 'isc_reset_fpe');
        isc_get_client_version := GetProcAddress(FGDS32Lib,
          'isc_get_client_version');
        isc_get_client_major_version := GetProcAddress(FGDS32Lib,
          'isc_get_client_major_version');
        isc_get_client_minor_version := GetProcAddress(FGDS32Lib,
      ...
      begin
        ...
        FB_SHUTDOWN_CALLBACK := GetProcAddress(FGDS32Lib,
        ...
        fb_disconnect_transaction := GetProcAddress(FGDS32Lib,
      ...
      Result := Assigned(BLOB_close) and Assigned(BLOB_dump) and
        ...
        Assigned(BLOB_open) and Assigned(BLOB_put) and Assigned(BLOB_text_dump)
        and Assigned(BLOB_text_load) and Assigned(Bopen) and
        Assigned(isc_add_user) and Assigned(isc_array_gen_sdl) and
        Assigned(isc_array_get_slice) and Assigned(isc_array_lookup_bounds) and
        Assigned(isc_array_lookup_desc) and Assigned(isc_array_put_slice) and
        Assigned(isc_array_set_desc) and Assigned(isc_attach_database) and
        Assigned(isc_blob_default_desc) and Assigned(isc_blob_gen_bpb) and
        Assigned(isc_blob_info) and Assigned(isc_blob_lookup_desc) and
        Assigned(isc_blob_set_desc) and Assigned(isc_cancel_blob) and
        Assigned(isc_cancel_events) and Assigned(isc_close) and
        ...
        Assigned(isc_database_info) and Assigned(isc_ddl) and
        Assigned(isc_declare) and Assigned(isc_decode_date) and
        Assigned(isc_decode_sql_date) and Assigned(isc_decode_sql_time) and
        Assigned(isc_decode_timestamp) and Assigned(isc_delete_user) and
        Assigned(isc_describe) and Assigned(isc_describe_bind) and
        Assigned(isc_detach_database) and Assigned(isc_drop_database) and
        Assigned(isc_dsql_alloc_statement2) and
        Assigned(isc_dsql_allocate_statement) and Assigned(isc_dsql_describe)
        and Assigned(isc_dsql_describe_bind) and Assigned(isc_dsql_exec_immed2)
        and Assigned(isc_dsql_exec_immed3_m) and Assigned(isc_dsql_execute) and
        Assigned(isc_dsql_execute_immediate) and
        Assigned(isc_dsql_execute_immediate_m) and Assigned(isc_dsql_execute_m)
        and Assigned(isc_dsql_execute2) and Assigned(isc_dsql_execute2_m) and
        ...
        Assigned(isc_embed_dsql_declare) and Assigned(isc_embed_dsql_describe)
        and Assigned(isc_embed_dsql_describe_bind) and
        Assigned(isc_embed_dsql_execute) and
        Assigned(isc_embed_dsql_execute_immed) and
        Assigned(isc_embed_dsql_execute2) and Assigned(isc_embed_dsql_fetch) and
        Assigned(isc_embed_dsql_insert) and Assigned(isc_embed_dsql_open) and
        Assigned(isc_embed_dsql_open2) and Assigned(isc_embed_dsql_prepare) and
        Assigned(isc_embed_dsql_release) and Assigned(isc_encode_date) and
        Assigned(isc_encode_sql_date) and Assigned(isc_encode_sql_time) and
        Assigned(isc_encode_timestamp) and Assigned(isc_event_block)
      { FB21_UP }
      ...
      { FB21_UP }
        ...
        Assigned(isc_free) and Assigned(isc_ftof) and Assigned(isc_get_segment)
        and Assigned(isc_fetch) and Assigned(isc_get_slice) and
        Assigned(isc_interprete) and Assigned(isc_modify_dpb) and
        Assigned(isc_modify_user) and Assigned(isc_open) and
        Assigned(isc_open_blob) and Assigned(isc_open_blob2) and
        Assigned(isc_portable_integer) and Assigned(isc_prepare) and
        Assigned(isc_prepare_transaction) and Assigned(isc_prepare_transaction2)
        and Assigned(isc_print_blr) and Assigned(isc_print_sqlerror) and
        Assigned(isc_print_status) and Assigned(isc_put_segment) and
        Assigned(isc_put_slice) and Assigned(isc_qtoq) and
        Assigned(isc_que_events) and Assigned(isc_receive) and
        Assigned(isc_reconnect_transaction) and Assigned(isc_release_request)
        and Assigned(isc_request_info) and Assigned(isc_rollback_retaining) and
        Assigned(isc_rollback_transaction) and Assigned(isc_seek_blob) and
        Assigned(isc_send) and Assigned(isc_service_attach) and
        ...
        Assigned(isc_sqlcode) and Assigned(isc_start_and_send) and
        Assigned(isc_start_multiple) and Assigned(isc_start_request) and
        Assigned(isc_start_transaction) and Assigned(isc_transact_request) and
        Assigned(isc_transaction_info) and Assigned(isc_unwind_request) and
        Assigned(isc_vax_integer) and Assigned(isc_version) and
        Assigned(isc_vtof) and Assigned(isc_vtov) and
        Assigned(isc_wait_for_event) and Assigned(isc_set_debug) and
        Assigned(BLOB_display)
      { FB15_UP }
        and ((not Version_Api_Is_FB15_Up) or (Assigned(isc_reset_fpe) and
        Assigned(isc_get_client_version) and
        Assigned(isc_get_client_major_version) and
        Assigned(isc_get_client_minor_version)))
      { FB15_UP }
      { FB20_UP }
        and ((not Version_Api_Is_FB20_Up) or Assigned(fb_interpret))
      { FB20_UP }
      { FB25_UP }
        and ((not Version_Api_Is_FB25_Up) or (Assigned(fb_print_blr) and
        Assigned(fb_shutdown) and Assigned(FB_SHUTDOWN_CALLBACK) and
        Assigned(fb_cancel_operation) and Assigned(fb_sqlstate) and
        Assigned(fb_disconnect_transaction)))
      { FB25_UP }
        ;

...
type
  ...
  TALFTPPropertyChangeEvent = procedure(sender: Tobject;
  ...
  { ------------------------------------------------------------------------------------------------------ }
  TALFTPClientUploadProgressEvent = procedure(sender: Tobject; Sent: Integer;
    Total: Integer) of object;
  TALFTPClientDownloadProgressEvent = procedure(sender: Tobject; Read: Integer;
    Total: Integer) of object;
  ...
  public
    ...
    property OnUploadProgress: TALFTPClientUploadProgressEvent
      read FOnUploadProgress write FOnUploadProgress;
    property OnDownloadProgress: TALFTPClientDownloadProgressEvent
...
{ **************************************************************************************** }
procedure TALFTPClient.OnProxyParamsChange(sender: Tobject;
...
{ ***************************************************** }
function TALFTPClient.FindFirst(const Path: AnsiString; const Attr: Integer;

...
type
  TSQLite3Callback = function(pArg: Pointer; nCol: Integer;
    argv: PPAnsiCharArray; colv: PPAnsiCharArray): Integer; cdecl;
...
type
  ...
  sqlite3_io_methods = record
    ...
    xRead: function(id: PSQLite3File; pBuf: Pointer; iAmt: Integer;
      iOfst: Int64): Integer; cdecl;
    xWrite: function(id: PSQLite3File; const pBuf: Pointer; iAmt: Integer;
      iOfst: Int64): Integer; cdecl;
    ...
    xCheckReservedLock: function(f: PSQLite3File; var pResOut: Integer)
      : Integer; cdecl;
    xFileControl: function(id: PSQLite3File; op: Integer; pArg: Pointer)
      : Integer; cdecl;
...
type
  ...
  sqlite3_vfs = record
    ...
    zName: PAnsiChar;
    pAppData: Pointer;
    xOpen: function(pVfs: PSQLite3VFS; const zName: PAnsiChar; id: PSQLite3File;
      flags: Integer; pOutFlags: PInteger): Integer; cdecl;
    xDelete: function(pVfs: PSQLite3VFS; const zName: PAnsiChar;
      syncDir: Integer): Integer; cdecl;
    xAccess: function(pVfs: PSQLite3VFS; const zName: PAnsiChar; flags: Integer;
      var pResOut: Integer): Integer; cdecl;
    xFullPathname: function(pVfs: PSQLite3VFS; const zName: PAnsiChar;
      nOut: Integer; zOut: PAnsiChar): Integer; cdecl;
    xDlOpen: function(pVfs: PSQLite3VFS; const zFilename: PAnsiChar)
      : Pointer; cdecl;
    xDlError: procedure(pVfs: PSQLite3VFS; nByte: Integer;
      zErrMsg: PAnsiChar); cdecl;
    xDlSym: function(pVfs: PSQLite3VFS; pHandle: Pointer;
      const zSymbol: PAnsiChar): Pointer; cdecl;
    xDlClose: procedure(pVfs: PSQLite3VFS; pHandle: Pointer); cdecl;
    xRandomness: function(pVfs: PSQLite3VFS; nByte: Integer; zOut: PAnsiChar)
      : Integer; cdecl;
    xSleep: function(pVfs: PSQLite3VFS; microseconds: Integer): Integer; cdecl;
    xCurrentTime: function(pVfs: PSQLite3VFS; var prNow: Double)
      : Integer; cdecl;
    xGetLastError: function(pVfs: PSQLite3VFS; nBuf: Integer; zBuf: PAnsiChar)
      : Integer; cdecl;
  end;
...
type
  TSQLite3AuthorizerCallback = function(pAuthArg: Pointer; code: Integer;
    const zTab: PAnsiChar; const zCol: PAnsiChar; const zDb: PAnsiChar;
    const zAuthContext: PAnsiChar): Integer; cdecl;
...
type
  TSQLite3TraceCallback = procedure(pTraceArg: Pointer;
    const zTrace: PAnsiChar); cdecl;
  TSQLite3ProfileCallback = procedure(pProfileArg: Pointer;
    const zSql: PAnsiChar; elapseTime: UInt64); cdecl;
...
type
  ...
  TPSQLite3ValueArray = array [0 .. MaxInt div SizeOf(PSQLite3Value) - 1]
    of PSQLite3Value;
...
type
  TSQLite3RegularFunction = procedure(ctx: PSQLite3Context; n: Integer;
    apVal: PPSQLite3ValueArray); cdecl;
  TSQLite3AggregateStep = procedure(ctx: PSQLite3Context; n: Integer;
    apVal: PPSQLite3ValueArray); cdecl;
...
type
  TSQLite3CollationCompare = procedure(pUser: Pointer; n1: Integer;
    const z1: Pointer; n2: Integer; const z2: Pointer); cdecl;
  TSQLite3CollationDestructor = procedure(pUser: Pointer); cdecl;

type
  TSQLite3CollationNeededCallback = procedure(pCollNeededArg: Pointer;
    db: PSQLite3; eTextRep: Integer; const zExternal: PAnsiChar); cdecl;
  TSQLite3CollationNeededCallback16 = procedure(pCollNeededArg: Pointer;
    db: PSQLite3; eTextRep: Integer; const zExternal: PWideChar); cdecl;
...
type
  TSQLite3UpdateCallback = procedure(pUpdateArg: Pointer; op: Integer;
    const zDb: PAnsiChar; const zTbl: PAnsiChar; iKey: Int64); cdecl;

type
  TSQLiteAutoExtensionEntryPoint = procedure; cdecl;

type
  TSQLite3FTS3Func = procedure(pContext: PSQLite3Context; argc: Integer;
    argv: PPSQLite3ValueArray); cdecl;
...
type
  ...
  sqlite3_module = record
    ...
    xCreate: function(db: PSQLite3; pAux: Pointer; argc: Integer;
      const argv: PPAnsiCharArray; var ppVTab: PSQLite3VTab;
      var pzErr: PAnsiChar): Integer; cdecl;
    xConnect: function(db: PSQLite3; pAux: Pointer; argc: Integer;
      const argv: PPAnsiCharArray; var ppVTab: PSQLite3VTab;
      var pzErr: PAnsiChar): Integer; cdecl;
    xBestIndex: function(pVTab: PSQLite3VTab; pInfo: PSQLite3IndexInfo)
      : Integer; cdecl;
    xDisconnect: function(pVTab: PSQLite3VTab): Integer; cdecl;
    xDestroy: function(pVTab: PSQLite3VTab): Integer; cdecl;
    xOpen: function(pVTab: PSQLite3VTab; var ppCursor: PSQLite3VTabCursor)
      : Integer; cdecl;
    xClose: function(pVtabCursor: PSQLite3VTabCursor): Integer; cdecl;
    xFilter: function(pVtabCursor: PSQLite3VTabCursor; idxNum: Integer;
      const idxStr: PAnsiChar; argc: Integer; argv: PPSQLite3ValueArray)
      : Integer; cdecl;
    xNext: function(pVtabCursor: PSQLite3VTabCursor): Integer; cdecl;
    xEof: function(pVtabCursor: PSQLite3VTabCursor): Integer; cdecl;
    xColumn: function(pVtabCursor: PSQLite3VTabCursor;
      sContext: PSQLite3Context; p2: Integer): Integer; cdecl;
    xRowid: function(pVtabCursor: PSQLite3VTabCursor; var pRowid: Int64)
      : Integer; cdecl;
    xUpdate: function(pVTab: PSQLite3VTab; nArg: Integer;
      ppArg: PPSQLite3ValueArray; var pRowid: Int64): Integer; cdecl;
    ...
    xFindFunction: function(pVTab: PSQLite3VTab; nArg: Integer;
      const zName: PAnsiChar; var pxFunc: TSQLite3FTS3Func; var ppArg: Pointer)
      : Integer; cdecl;
    xRename: function(pVTab: PSQLite3VTab; const zNew: PAnsiChar)
      : Integer; cdecl;
  end;
  ...
  TSQLite3IndexConstraintArray = array
    [0 .. MaxInt div SizeOf(TSQLite3IndexConstraint) - 1]
    of TSQLite3IndexConstraint;
  ...
  TSQLite3IndexOrderByArray = array
    [0 .. MaxInt div SizeOf(TSQLite3IndexOrderBy) - 1] of TSQLite3IndexOrderBy;
  ...
  TSQLite3IndexConstraintUsageArray = array
    [0 .. MaxInt div SizeOf(TSQLite3IndexConstraintUsage) - 1]
    of TSQLite3IndexConstraintUsage;
...
type
  sqlite3_pcache_methods = record
    ...
    xFetch: function(pCache: PSQLite3PCache; key: Cardinal; createFlag: Integer)
      : Pointer; cdecl;
    xUnpin: procedure(pCache: PSQLite3PCache; pPg: Pointer;
      discard: Integer); cdecl;
    xRekey: procedure(pCache: PSQLite3PCache; pPg: Pointer; oldKey: Cardinal;
      newKey: Cardinal); cdecl;
...
type
  TSQLite3UnlockNotifyCallback = procedure(apArg: PPointerArray;
    nArg: Integer); cdecl;
...
type
  ...
  public
    ...
    sqlite3_exec: function(db: PSQLite3; const sql: PAnsiChar;
      callback: TSQLite3Callback; pArg: Pointer; errmsg: PPAnsiChar)
      : Integer; cdecl;
    ...
    sqlite3_db_config: function(db: PSQLite3; op: Integer { ; ... } )
      : Integer; cdecl;
    sqlite3_extended_result_codes: function(db: PSQLite3; onoff: Integer)
      : Integer; cdecl;
    ...
    sqlite3_busy_handler: function(db: PSQLite3; xBusy: TSQLite3BusyCallback;
      pArg: Pointer): Integer; cdecl;
    sqlite3_busy_timeout: function(db: PSQLite3; ms: Integer): Integer; cdecl;
    sqlite3_get_table: function(db: PSQLite3; const zSql: PAnsiChar;
      var pazResult: PPAnsiCharArray; pnRow: PInteger; pnColumn: PInteger;
      pzErrmsg: PPAnsiChar): Integer; cdecl;
    sqlite3_free_table: procedure(result: PPAnsiCharArray); cdecl;
    sqlite3_mprintf: function(const zFormat: PAnsiChar { ; ... } )
      : PAnsiChar; cdecl;
    sqlite3_vmprintf: function(const zFormat: PAnsiChar;
      ap: Pointer { va_list } ): PAnsiChar; cdecl;
    sqlite3_snprintf: function(n: Integer; zBuf: PAnsiChar;
      const zFormat: PAnsiChar { ; ... } ): PAnsiChar; cdecl;
    ...
    sqlite3_set_authorizer: function(db: PSQLite3;
      xAuth: TSQLite3AuthorizerCallback; pUserData: Pointer): Integer; cdecl;
    sqlite3_trace: function(db: PSQLite3; xTrace: TSQLite3TraceCallback;
      pArg: Pointer): Pointer; cdecl;
    sqlite3_profile: function(db: PSQLite3; xProfile: TSQLite3ProfileCallback;
      pArg: Pointer): Pointer; cdecl;
    sqlite3_progress_handler: procedure(db: PSQLite3; nOps: Integer;
      xProgress: TSQLite3ProgressCallback; pArg: Pointer); cdecl;
    sqlite3_open: function(const filename: PAnsiChar; var ppDb: PSQLite3)
      : Integer; cdecl;
    sqlite3_open16: function(const filename: PWideChar; var ppDb: PSQLite3)
      : Integer; cdecl;
    sqlite3_open_v2: function(const filename: PAnsiChar; var ppDb: PSQLite3;
      flags: Integer; const zVfs: PAnsiChar): Integer; cdecl;
    ...
    sqlite3_limit: function(db: PSQLite3; limitId: Integer; newLimit: Integer)
      : Integer; cdecl;
    sqlite3_prepare: function(db: PSQLite3; const zSql: PAnsiChar;
      nByte: Integer; var ppStmt: PSQLite3Stmt; const pzTail: PPAnsiChar)
      : Integer; cdecl;
    sqlite3_prepare_v2: function(db: PSQLite3; const zSql: PAnsiChar;
      nByte: Integer; var ppStmt: PSQLite3Stmt; const pzTail: PPAnsiChar)
      : Integer; cdecl;
    sqlite3_prepare16: function(db: PSQLite3; const zSql: PWideChar;
      nByte: Integer; var ppStmt: PSQLite3Stmt; const pzTail: PPWideChar)
      : Integer; cdecl;
    sqlite3_prepare16_v2: function(db: PSQLite3; const zSql: PWideChar;
      nByte: Integer; var ppStmt: PSQLite3Stmt; const pzTail: PPWideChar)
      : Integer; cdecl;
    sqlite3_sql: function(pStmt: PSQLite3Stmt): PAnsiChar; cdecl;
    sqlite3_bind_blob: function(pStmt: PSQLite3Stmt; i: Integer;
      const zData: Pointer; n: Integer; xDel: TSQLite3DestructorType)
      : Integer; cdecl;
    sqlite3_bind_double: function(pStmt: PSQLite3Stmt; i: Integer;
      rValue: Double): Integer; cdecl;
    sqlite3_bind_int: function(p: PSQLite3Stmt; i: Integer; iValue: Integer)
      : Integer; cdecl;
    sqlite3_bind_int64: function(pStmt: PSQLite3Stmt; i: Integer; iValue: Int64)
      : Integer; cdecl;
    sqlite3_bind_null: function(pStmt: PSQLite3Stmt; i: Integer)
      : Integer; cdecl;
    sqlite3_bind_text: function(pStmt: PSQLite3Stmt; i: Integer;
      const zData: PAnsiChar; n: Integer; xDel: TSQLite3DestructorType)
      : Integer; cdecl;
    sqlite3_bind_text16: function(pStmt: PSQLite3Stmt; i: Integer;
      const zData: PWideChar; nData: Integer; xDel: TSQLite3DestructorType)
      : Integer; cdecl;
    sqlite3_bind_value: function(pStmt: PSQLite3Stmt; i: Integer;
      const pValue: PSQLite3Value): Integer; cdecl;
    sqlite3_bind_zeroblob: function(pStmt: PSQLite3Stmt; i: Integer; n: Integer)
      : Integer; cdecl;
    sqlite3_bind_parameter_count: function(pStmt: PSQLite3Stmt): Integer; cdecl;
    sqlite3_bind_parameter_name: function(pStmt: PSQLite3Stmt; i: Integer)
      : PAnsiChar; cdecl;
    sqlite3_bind_parameter_index: function(pStmt: PSQLite3Stmt;
      const zName: PAnsiChar): Integer; cdecl;
    ...
    sqlite3_column_name: function(pStmt: PSQLite3Stmt; n: Integer)
      : PAnsiChar; cdecl;
    sqlite3_column_name16: function(pStmt: PSQLite3Stmt; n: Integer)
      : PWideChar; cdecl;
    sqlite3_column_database_name: function(pStmt: PSQLite3Stmt; n: Integer)
      : PAnsiChar; cdecl;
    sqlite3_column_database_name16: function(pStmt: PSQLite3Stmt; n: Integer)
      : PWideChar; cdecl;
    sqlite3_column_table_name: function(pStmt: PSQLite3Stmt; n: Integer)
      : PAnsiChar; cdecl;
    sqlite3_column_table_name16: function(pStmt: PSQLite3Stmt; n: Integer)
      : PWideChar; cdecl;
    sqlite3_column_origin_name: function(pStmt: PSQLite3Stmt; n: Integer)
      : PAnsiChar; cdecl;
    sqlite3_column_origin_name16: function(pStmt: PSQLite3Stmt; n: Integer)
      : PWideChar; cdecl;
    sqlite3_column_decltype: function(pStmt: PSQLite3Stmt; n: Integer)
      : PAnsiChar; cdecl;
    sqlite3_column_decltype16: function(pStmt: PSQLite3Stmt; n: Integer)
      : PWideChar; cdecl;
    sqlite3_step: function(pStmt: PSQLite3Stmt): Integer; cdecl;
    sqlite3_data_count: function(pStmt: PSQLite3Stmt): Integer; cdecl;
    sqlite3_column_blob: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : Pointer; cdecl;
    sqlite3_column_bytes: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : Integer; cdecl;
    sqlite3_column_bytes16: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : Integer; cdecl;
    sqlite3_column_double: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : Double; cdecl;
    sqlite3_column_int: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : Integer; cdecl;
    sqlite3_column_int64: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : Int64; cdecl;
    sqlite3_column_text: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : PAnsiChar; cdecl;
    sqlite3_column_text16: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : PWideChar; cdecl;
    sqlite3_column_type: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : Integer; cdecl;
    sqlite3_column_value: function(pStmt: PSQLite3Stmt; iCol: Integer)
      : PSQLite3Value; cdecl;
    sqlite3_finalize: function(pStmt: PSQLite3Stmt): Integer; cdecl;
    sqlite3_reset: function(pStmt: PSQLite3Stmt): Integer; cdecl;
    sqlite3_create_function: function(db: PSQLite3;
      const zFunctionName: PAnsiChar; nArg: Integer; eTextRep: Integer;
      pApp: Pointer; xFunc: TSQLite3RegularFunction;
      xStep: TSQLite3AggregateStep; xFinal: TSQLite3AggregateFinalize)
      : Integer; cdecl;
    sqlite3_create_function16: function(db: PSQLite3;
      const zFunctionName: PWideChar; nArg: Integer; eTextRep: Integer;
      pApp: Pointer; xFunc: TSQLite3RegularFunction;
      xStep: TSQLite3AggregateStep; xFinal: TSQLite3AggregateFinalize)
      : Integer; cdecl;
    ...
    sqlite3_aggregate_context: function(p: PSQLite3Context; nBytes: Integer)
      : Pointer; cdecl;
    ...
    sqlite3_get_auxdata: function(pCtx: PSQLite3Context; n: Integer)
      : Pointer; cdecl;
    sqlite3_set_auxdata: procedure(pCtx: PSQLite3Context; n: Integer;
      pAux: Pointer; xDelete: TSQLite3AuxDataDestructor); cdecl;
    sqlite3_result_blob: procedure(pCtx: PSQLite3Context; const z: Pointer;
      n: Integer; xDel: TSQLite3DestructorType); cdecl;
    sqlite3_result_double: procedure(pCtx: PSQLite3Context;
      rVal: Double); cdecl;
    sqlite3_result_error: procedure(pCtx: PSQLite3Context; const z: PAnsiChar;
      n: Integer); cdecl;
    sqlite3_result_error16: procedure(pCtx: PSQLite3Context; const z: PWideChar;
      n: Integer); cdecl;
    ...
    sqlite3_result_error_code: procedure(pCtx: PSQLite3Context;
    ...
    sqlite3_result_text: procedure(pCtx: PSQLite3Context; const z: PAnsiChar;
      n: Integer; xDel: TSQLite3DestructorType); cdecl;
    sqlite3_result_text16: procedure(pCtx: PSQLite3Context; const z: PWideChar;
      n: Integer; xDel: TSQLite3DestructorType); cdecl;
    sqlite3_result_text16le: procedure(pCtx: PSQLite3Context; const z: Pointer;
      n: Integer; xDel: TSQLite3DestructorType); cdecl;
    sqlite3_result_text16be: procedure(pCtx: PSQLite3Context; const z: Pointer;
      n: Integer; xDel: TSQLite3DestructorType); cdecl;
    sqlite3_result_value: procedure(pCtx: PSQLite3Context;
      pValue: PSQLite3Value); cdecl;
    sqlite3_result_zeroblob: procedure(pCtx: PSQLite3Context;
      n: Integer); cdecl;
    sqlite3_create_collation: function(db: PSQLite3; const zName: PAnsiChar;
      eTextRep: Integer; pUser: Pointer; xCompare: TSQLite3CollationCompare)
      : Integer; cdecl;
    sqlite3_create_collation_v2: function(db: PSQLite3; const zName: PAnsiChar;
      eTextRep: Integer; pUser: Pointer; xCompare: TSQLite3CollationCompare;
      xDestroy: TSQLite3CollationDestructor): Integer; cdecl;
    sqlite3_create_collation16: function(db: PSQLite3; const zName: PWideChar;
      eTextRep: Integer; pUser: Pointer; xCompare: TSQLite3CollationCompare)
      : Integer; cdecl;
    sqlite3_collation_needed: function(db: PSQLite3; pCollNeededArg: Pointer;
      xCollNeeded: TSQLite3CollationNeededCallback): Integer; cdecl;
    sqlite3_collation_needed16: function(db: PSQLite3; pCollNeededArg: Pointer;
      xCollNeeded16: TSQLite3CollationNeededCallback16): Integer; cdecl;
    ...
    sqlite3_next_stmt: function(pDb: PSQLite3; pStmt: PSQLite3Stmt)
      : PSQLite3Stmt; cdecl;
    sqlite3_commit_hook: function(db: PSQLite3;
      xCallback: TSQLite3CommitCallback; pArg: Pointer): Pointer; cdecl;
    sqlite3_rollback_hook: function(db: PSQLite3;
      xCallback: TSQLite3RollbackCallback; pArg: Pointer): Pointer; cdecl;
    sqlite3_update_hook: function(db: PSQLite3;
      xCallback: TSQLite3UpdateCallback; pArg: Pointer): Pointer; cdecl;
    ...
    sqlite3_table_column_metadata: function(db: PSQLite3;
      const zDbName: PAnsiChar; const zTableName: PAnsiChar;
      const zColumnName: PAnsiChar; const pzDataType: PPAnsiChar;
      const pzCollSeq: PPAnsiChar; pNotNull: PInteger; pPrimaryKey: PInteger;
      pAutoinc: PInteger): Integer; cdecl;
    sqlite3_load_extension: function(db: PSQLite3; const zFile: PAnsiChar;
      const zProc: PAnsiChar; pzErrmsg: PPAnsiChar): Integer; cdecl;
    sqlite3_enable_load_extension: function(db: PSQLite3; onoff: Integer)
      : Integer; cdecl;
    sqlite3_auto_extension
      : function(xEntryPoint: TSQLiteAutoExtensionEntryPoint): Integer; cdecl;
    sqlite3_reset_auto_extension: procedure; cdecl;
    sqlite3_create_module: function(db: PSQLite3; const zName: PAnsiChar;
      const p: PSQLite3Module; pClientData: Pointer): Integer; cdecl;
    sqlite3_create_module_v2: function(db: PSQLite3; const zName: PAnsiChar;
      const p: PSQLite3Module; pClientData: Pointer;
      xDestroy: TSQLite3ModuleDestructor): Integer; cdecl;
    sqlite3_declare_vtab: function(db: PSQLite3; const zSql: PAnsiChar)
      : Integer; cdecl;
    sqlite3_overload_function: function(db: PSQLite3;
      const zFuncName: PAnsiChar; nArg: Integer): Integer; cdecl;
    sqlite3_blob_open: function(db: PSQLite3; const zDb: PAnsiChar;
      const zTable: PAnsiChar; const zColumn: PAnsiChar; iRow: Int64;
      flags: Integer; var ppBlob: PSQLite3Blob): Integer; cdecl;
    sqlite3_blob_close: function(pBlob: PSQLite3Blob): Integer; cdecl;
    sqlite3_blob_bytes: function(pBlob: PSQLite3Blob): Integer; cdecl;
    sqlite3_blob_read: function(pBlob: PSQLite3Blob; z: Pointer; n: Integer;
      iOffset: Integer): Integer; cdecl;
    sqlite3_blob_write: function(pBlob: PSQLite3Blob; const z: Pointer;
      n: Integer; iOffset: Integer): Integer; cdecl;
    sqlite3_vfs_find: function(const zVfsName: PAnsiChar): PSQLite3VFS; cdecl;
    sqlite3_vfs_register: function(pVfs: PSQLite3VFS; makeDflt: Integer)
      : Integer; cdecl;
    ...
    sqlite3_file_control: function(db: PSQLite3; const zDbName: PAnsiChar;
      op: Integer; pArg: Pointer): Integer; cdecl;
    ...
    sqlite3_db_status: function(db: PSQLite3; op: Integer; var pCur: Integer;
      var pHiwtr: Integer; resetFlg: Integer): Integer; cdecl;
    sqlite3_stmt_status: function(pStmt: PSQLite3Stmt; op: Integer;
      resetFlg: Integer): Integer; cdecl;
    sqlite3_backup_init: function(pDest: PSQLite3; const zDestName: PAnsiChar;
      pSource: PSQLite3; const zSourceName: PAnsiChar): PSQLite3Backup; cdecl;
    sqlite3_backup_step: function(p: PSQLite3Backup; nPage: Integer)
      : Integer; cdecl;
    ...
    sqlite3_strnicmp: function(const zLeft: PAnsiChar; const zRight: PAnsiChar;
      n: Integer): Integer; cdecl;
    constructor Create; virtual;
    destructor Destroy; override;
    function Loaded: Boolean; virtual;
    function Unload: Boolean; virtual;
    function Load(const lib: AnsiString = 'sqlite3.dll';
      const initialize: Boolean = True): Boolean; virtual;
  end;
...
{ ************************************************************************************************************ }
function TALSqlite3Library.Load(const lib: AnsiString = 'sqlite3.dll';
  const initialize: Boolean = True): Boolean;
Begin
  result := Loaded;
  if not result then
  begin
    ...
    begin
      ...
      sqlite3_libversion_number := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_extended_result_codes := GetProcAddress(Flibsqlite3,
        'sqlite3_extended_result_codes');
      sqlite3_last_insert_rowid := GetProcAddress(Flibsqlite3,
        'sqlite3_last_insert_rowid');
      sqlite3_changes := GetProcAddress(Flibsqlite3, 'sqlite3_changes');
      sqlite3_total_changes := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_busy_handler := GetProcAddress(Flibsqlite3,
        'sqlite3_busy_handler');
      sqlite3_busy_timeout := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_extended_errcode := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_prepare16_v2 := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_bind_zeroblob := GetProcAddress(Flibsqlite3,
        'sqlite3_bind_zeroblob');
      sqlite3_bind_parameter_count := GetProcAddress(Flibsqlite3,
        'sqlite3_bind_parameter_count');
      sqlite3_bind_parameter_name := GetProcAddress(Flibsqlite3,
        'sqlite3_bind_parameter_name');
      sqlite3_bind_parameter_index := GetProcAddress(Flibsqlite3,
        'sqlite3_bind_parameter_index');
      sqlite3_clear_bindings := GetProcAddress(Flibsqlite3,
        'sqlite3_clear_bindings');
      sqlite3_column_count := GetProcAddress(Flibsqlite3,
        'sqlite3_column_count');
      sqlite3_column_name := GetProcAddress(Flibsqlite3, 'sqlite3_column_name');
      sqlite3_column_name16 := GetProcAddress(Flibsqlite3,
        'sqlite3_column_name16');
      sqlite3_column_database_name := GetProcAddress(Flibsqlite3,
        'sqlite3_column_database_name');
      sqlite3_column_database_name16 := GetProcAddress(Flibsqlite3,
        'sqlite3_column_database_name16');
      sqlite3_column_table_name := GetProcAddress(Flibsqlite3,
        'sqlite3_column_table_name');
      sqlite3_column_table_name16 := GetProcAddress(Flibsqlite3,
        'sqlite3_column_table_name16');
      sqlite3_column_origin_name := GetProcAddress(Flibsqlite3,
        'sqlite3_column_origin_name');
      sqlite3_column_origin_name16 := GetProcAddress(Flibsqlite3,
        'sqlite3_column_origin_name16');
      sqlite3_column_decltype := GetProcAddress(Flibsqlite3,
        'sqlite3_column_decltype');
      sqlite3_column_decltype16 := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_column_bytes := GetProcAddress(Flibsqlite3,
        'sqlite3_column_bytes');
      sqlite3_column_bytes16 := GetProcAddress(Flibsqlite3,
        'sqlite3_column_bytes16');
      sqlite3_column_double := GetProcAddress(Flibsqlite3,
        'sqlite3_column_double');
      sqlite3_column_int := GetProcAddress(Flibsqlite3, 'sqlite3_column_int');
      sqlite3_column_int64 := GetProcAddress(Flibsqlite3,
        'sqlite3_column_int64');
      sqlite3_column_text := GetProcAddress(Flibsqlite3, 'sqlite3_column_text');
      sqlite3_column_text16 := GetProcAddress(Flibsqlite3,
        'sqlite3_column_text16');
      sqlite3_column_type := GetProcAddress(Flibsqlite3, 'sqlite3_column_type');
      sqlite3_column_value := GetProcAddress(Flibsqlite3,
        'sqlite3_column_value');
      sqlite3_finalize := GetProcAddress(Flibsqlite3, 'sqlite3_finalize');
      sqlite3_reset := GetProcAddress(Flibsqlite3, 'sqlite3_reset');
      sqlite3_create_function := GetProcAddress(Flibsqlite3,
        'sqlite3_create_function');
      sqlite3_create_function16 := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_value_bytes16 := GetProcAddress(Flibsqlite3,
        'sqlite3_value_bytes16');
      sqlite3_value_double := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_value_text16 := GetProcAddress(Flibsqlite3,
        'sqlite3_value_text16');
      sqlite3_value_text16le := GetProcAddress(Flibsqlite3,
        'sqlite3_value_text16le');
      sqlite3_value_text16be := GetProcAddress(Flibsqlite3,
        'sqlite3_value_text16be');
      sqlite3_value_type := GetProcAddress(Flibsqlite3, 'sqlite3_value_type');
      sqlite3_value_numeric_type := GetProcAddress(Flibsqlite3,
        'sqlite3_value_numeric_type');
      sqlite3_aggregate_context := GetProcAddress(Flibsqlite3,
        'sqlite3_aggregate_context');
      sqlite3_user_data := GetProcAddress(Flibsqlite3, 'sqlite3_user_data');
      sqlite3_context_db_handle := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_result_double := GetProcAddress(Flibsqlite3,
        'sqlite3_result_double');
      sqlite3_result_error := GetProcAddress(Flibsqlite3,
        'sqlite3_result_error');
      sqlite3_result_error16 := GetProcAddress(Flibsqlite3,
        'sqlite3_result_error16');
      sqlite3_result_error_toobig := GetProcAddress(Flibsqlite3,
        'sqlite3_result_error_toobig');
      sqlite3_result_error_nomem := GetProcAddress(Flibsqlite3,
        'sqlite3_result_error_nomem');
      sqlite3_result_error_code := GetProcAddress(Flibsqlite3,
        'sqlite3_result_error_code');
      sqlite3_result_int := GetProcAddress(Flibsqlite3, 'sqlite3_result_int');
      sqlite3_result_int64 := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_result_text16 := GetProcAddress(Flibsqlite3,
        'sqlite3_result_text16');
      sqlite3_result_text16le := GetProcAddress(Flibsqlite3,
        'sqlite3_result_text16le');
      sqlite3_result_text16be := GetProcAddress(Flibsqlite3,
        'sqlite3_result_text16be');
      sqlite3_result_value := GetProcAddress(Flibsqlite3,
        'sqlite3_result_value');
      sqlite3_result_zeroblob := GetProcAddress(Flibsqlite3,
        'sqlite3_result_zeroblob');
      sqlite3_create_collation := GetProcAddress(Flibsqlite3,
        'sqlite3_create_collation');
      sqlite3_create_collation_v2 := GetProcAddress(Flibsqlite3,
        'sqlite3_create_collation_v2');
      sqlite3_create_collation16 := GetProcAddress(Flibsqlite3,
        'sqlite3_create_collation16');
      sqlite3_collation_needed := GetProcAddress(Flibsqlite3,
        'sqlite3_collation_needed');
      sqlite3_collation_needed16 := GetProcAddress(Flibsqlite3,
        'sqlite3_collation_needed16');
      sqlite3_sleep := GetProcAddress(Flibsqlite3, 'sqlite3_sleep');
      sqlite3_get_autocommit := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_rollback_hook := GetProcAddress(Flibsqlite3,
        'sqlite3_rollback_hook');
      sqlite3_update_hook := GetProcAddress(Flibsqlite3, 'sqlite3_update_hook');
      sqlite3_enable_shared_cache := GetProcAddress(Flibsqlite3,
        'sqlite3_enable_shared_cache');
      sqlite3_release_memory := GetProcAddress(Flibsqlite3,
        'sqlite3_release_memory');
      sqlite3_soft_heap_limit64 := GetProcAddress(Flibsqlite3,
        'sqlite3_soft_heap_limit64');
      sqlite3_table_column_metadata := GetProcAddress(Flibsqlite3,
        'sqlite3_table_column_metadata');
      sqlite3_load_extension := GetProcAddress(Flibsqlite3,
        'sqlite3_load_extension');
      sqlite3_enable_load_extension := GetProcAddress(Flibsqlite3,
        'sqlite3_enable_load_extension');
      sqlite3_auto_extension := GetProcAddress(Flibsqlite3,
        'sqlite3_auto_extension');
      sqlite3_reset_auto_extension := GetProcAddress(Flibsqlite3,
        'sqlite3_reset_auto_extension');
      sqlite3_create_module := GetProcAddress(Flibsqlite3,
        'sqlite3_create_module');
      sqlite3_create_module_v2 := GetProcAddress(Flibsqlite3,
        'sqlite3_create_module_v2');
      sqlite3_declare_vtab := GetProcAddress(Flibsqlite3,
        'sqlite3_declare_vtab');
      sqlite3_overload_function := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_vfs_register := GetProcAddress(Flibsqlite3,
        'sqlite3_vfs_register');
      sqlite3_vfs_unregister := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_file_control := GetProcAddress(Flibsqlite3,
        'sqlite3_file_control');
      sqlite3_test_control := GetProcAddress(Flibsqlite3,
      ...
      sqlite3_backup_finish := GetProcAddress(Flibsqlite3,
        'sqlite3_backup_finish');
      sqlite3_backup_remaining := GetProcAddress(Flibsqlite3,
        'sqlite3_backup_remaining');
      sqlite3_backup_pagecount := GetProcAddress(Flibsqlite3,
        'sqlite3_backup_pagecount');
      sqlite3_strnicmp := GetProcAddress(Flibsqlite3, 'sqlite3_strnicmp');

      result := assigned(sqlite3_libversion) and assigned(sqlite3_sourceid) and
        assigned(sqlite3_libversion_number) and assigned(sqlite3_threadsafe) and
        assigned(sqlite3_close) and assigned(sqlite3_exec) and
        assigned(sqlite3_initialize) and assigned(sqlite3_shutdown) and
        assigned(sqlite3_os_init) and assigned(sqlite3_os_end) and
        assigned(sqlite3_config) and assigned(sqlite3_db_config) and
        assigned(sqlite3_extended_result_codes) and
        assigned(sqlite3_last_insert_rowid) and assigned(sqlite3_changes) and
        assigned(sqlite3_total_changes) and assigned(sqlite3_interrupt) and
        assigned(sqlite3_complete) and assigned(sqlite3_complete16) and
        assigned(sqlite3_busy_handler) and assigned(sqlite3_busy_timeout) and
        assigned(sqlite3_get_table) and assigned(sqlite3_free_table) and
        assigned(sqlite3_mprintf) and assigned(sqlite3_vmprintf) and
        assigned(sqlite3_snprintf) and assigned(sqlite3_malloc) and
        assigned(sqlite3_realloc) and assigned(sqlite3_free) and
        assigned(sqlite3_memory_used) and assigned(sqlite3_memory_highwater) and
        assigned(sqlite3_randomness) and assigned(sqlite3_set_authorizer) and
        assigned(sqlite3_trace) and assigned(sqlite3_profile) and
        assigned(sqlite3_progress_handler) and assigned(sqlite3_open) and
        assigned(sqlite3_open16) and assigned(sqlite3_open_v2) and
        assigned(sqlite3_errcode) and assigned(sqlite3_extended_errcode) and
        assigned(sqlite3_errmsg) and assigned(sqlite3_errmsg16) and
        assigned(sqlite3_limit) and assigned(sqlite3_prepare) and
        assigned(sqlite3_prepare_v2) and assigned(sqlite3_prepare16) and
        assigned(sqlite3_prepare16_v2) and assigned(sqlite3_sql) and
        assigned(sqlite3_bind_blob) and assigned(sqlite3_bind_double) and
        assigned(sqlite3_bind_int) and assigned(sqlite3_bind_int64) and
        assigned(sqlite3_bind_null) and assigned(sqlite3_bind_text) and
        assigned(sqlite3_bind_text16) and assigned(sqlite3_bind_value) and
        ...
        assigned(sqlite3_clear_bindings) and assigned(sqlite3_column_count) and
        assigned(sqlite3_column_name) and assigned(sqlite3_column_name16) and
        ...
        assigned(sqlite3_column_decltype16) and assigned(sqlite3_step) and
        assigned(sqlite3_data_count) and assigned(sqlite3_column_blob) and
        assigned(sqlite3_column_bytes) and assigned(sqlite3_column_bytes16) and
        assigned(sqlite3_column_double) and assigned(sqlite3_column_int) and
        assigned(sqlite3_column_int64) and assigned(sqlite3_column_text) and
        assigned(sqlite3_column_text16) and assigned(sqlite3_column_type) and
        assigned(sqlite3_column_value) and assigned(sqlite3_finalize) and
        assigned(sqlite3_reset) and assigned(sqlite3_create_function) and
        assigned(sqlite3_create_function16) and assigned(sqlite3_value_blob) and
        assigned(sqlite3_value_bytes) and assigned(sqlite3_value_bytes16) and
        assigned(sqlite3_value_double) and assigned(sqlite3_value_int) and
        assigned(sqlite3_value_int64) and assigned(sqlite3_value_text) and
        assigned(sqlite3_value_text16) and assigned(sqlite3_value_text16le) and
        assigned(sqlite3_value_text16be) and assigned(sqlite3_value_type) and
        assigned(sqlite3_value_numeric_type) and
        assigned(sqlite3_aggregate_context) and assigned(sqlite3_user_data) and
        assigned(sqlite3_context_db_handle) and assigned(sqlite3_get_auxdata)
        and assigned(sqlite3_set_auxdata) and assigned(sqlite3_result_blob) and
        assigned(sqlite3_result_double) and assigned(sqlite3_result_error) and
        assigned(sqlite3_result_error16) and
        assigned(sqlite3_result_error_toobig) and
        assigned(sqlite3_result_error_nomem) and
        assigned(sqlite3_result_error_code) and assigned(sqlite3_result_int) and
        assigned(sqlite3_result_int64) and assigned(sqlite3_result_null) and
        assigned(sqlite3_result_text) and assigned(sqlite3_result_text16) and
        assigned(sqlite3_result_text16le) and assigned(sqlite3_result_text16be)
        and assigned(sqlite3_result_value) and assigned(sqlite3_result_zeroblob)
        and assigned(sqlite3_create_collation) and
        assigned(sqlite3_create_collation_v2) and
        assigned(sqlite3_create_collation16) and
        assigned(sqlite3_collation_needed) and
        assigned(sqlite3_collation_needed16) and assigned(sqlite3_sleep) and
        assigned(sqlite3_get_autocommit) and assigned(sqlite3_db_handle) and
        assigned(sqlite3_next_stmt) and assigned(sqlite3_commit_hook) and
        assigned(sqlite3_rollback_hook) and assigned(sqlite3_update_hook) and
        assigned(sqlite3_enable_shared_cache) and
        assigned(sqlite3_release_memory) and assigned(sqlite3_soft_heap_limit64)
        and assigned(sqlite3_table_column_metadata) and
        ...
        assigned(sqlite3_create_module) and assigned(sqlite3_create_module_v2)
        and assigned(sqlite3_declare_vtab) and
        assigned(sqlite3_overload_function) and assigned(sqlite3_blob_open) and
        assigned(sqlite3_blob_close) and assigned(sqlite3_blob_bytes) and
        assigned(sqlite3_blob_read) and assigned(sqlite3_blob_write) and
        assigned(sqlite3_vfs_find) and assigned(sqlite3_vfs_register) and
        assigned(sqlite3_vfs_unregister) and assigned(sqlite3_mutex_alloc) and
        assigned(sqlite3_mutex_free) and assigned(sqlite3_mutex_enter) and
        assigned(sqlite3_mutex_try) and assigned(sqlite3_mutex_leave) and
        assigned(sqlite3_db_mutex) and assigned(sqlite3_file_control) and
        assigned(sqlite3_test_control) and assigned(sqlite3_status) and
        assigned(sqlite3_db_status) and assigned(sqlite3_stmt_status) and
        assigned(sqlite3_backup_init) and assigned(sqlite3_backup_step) and
        assigned(sqlite3_backup_finish) and assigned(sqlite3_backup_remaining)
        and assigned(sqlite3_backup_pagecount) and assigned(sqlite3_strnicmp);
